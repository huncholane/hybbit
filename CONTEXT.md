...
Domain language for Hygo's analytics product, documentation, and public tools.

## Language

**Site**:
A web domain or mobile application whose activity Hygo measures for an Organization.
...
A caller-supplied HTTP or HTTPS location that resolves only to public network addresses and can be inspected by Hygo's free analytics tools.
