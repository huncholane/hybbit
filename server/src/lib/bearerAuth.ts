...
export { ORG_API_KEY_CONFIG_ID } from "@hygo/shared";
import { ORG_API_KEY_CONFIG_ID } from "@hygo/shared";
 ...
 */
export const INTERNAL_BEARER_HANDOFF_HEADER = "x-hygo-mcp-bearer";
