...
const defaultsByStatus: Record<number, { code: string; message: string; resolution: string }> = {
  400: {
    ...
    resolution: "Check the request parameters and body against https://hygo.ai/openapi.json.",
  },
  401: {
  ...
  404: {
    ...
    resolution: "Check identifiers and paths against https://hygo.ai/openapi.json.",
  },
  405: {
    code: "METHOD_NOT_ALLOWED",
    message: "The HTTP method is not supported for this path.",
    resolution: "Choose a method listed for this path in https://hygo.ai/openapi.json.",
  },
  409: {
    code: "CONFLICT",
