...
export const ONBOARDING_TIPS: OnboardingTipContent[] = [
  {
    ...
    body: `Thanks for signing up for Hygo. You've joined thousands of developers who care about respecting their users' privacy.

Unlike traditional analytics tools, Hygo doesn't use cookies, doesn't track users across websites, and doesn't sell your data to advertisers. Your visitors stay anonymous, and you still get the insights you need.

We built Hygo because we were tired of tools that treat users as products. Privacy shouldn't mean giving up on understanding your audience.

If you're curious how we compare to other tools, check out our comparison page.`,
    linkText: "View comparison",
    linkUrl: "https://hygo.ai/docs/comparison",
  },
  {
    day: 2,
    subject: "Why your metrics might look different than GA",
    body: `If you've been using Google Analytics before, you might notice your Hygo numbers look different. That's actually a good thing.

Adblockers block Google Analytics. They rarely block Hygo. So for the first time, you're probably seeing your real traffic - and it's likely higher than GA ever showed you.
...
Events show up in your dashboard and can be used as funnel steps or goal triggers.`,
    ...
    linkUrl: "https://hygo.ai/docs/track-events",
  },
  {
    day: 4,
...
Funnels go deeper. Define a multi-step process (view product -> add to cart -> checkout -> purchase) and see exactly where users drop off. Finding a 60% drop-off at checkout? Now you know where to focus.`,
    ...
    linkUrl: "https://hygo.ai/docs/web-analytics/goals-tab",
  },
  {
    day: 5,
    subject: "Build with your data",
    body: `Everything in your Hygo dashboard is available through our API.
...
Authentication is simple (API key in header), and the endpoints mirror what you see in the UI. Query pageviews, events, sessions, funnels - whatever you need.`,
    ...
    linkUrl: "https://hygo.ai/docs/api/getting-started",
  },
];
