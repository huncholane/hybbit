 ...
 * (op.gg's Hygo instance, 2026-08-18), so the pairs that must collapse are
...
const UA = {
  ...
  reactNative:
    "Mozilla/5.0 (iPhone; CPU iPhone OS 26_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) HygoReactNative/0.1.1 8.0.14",
  reactNativeBumped:
    "Mozilla/5.0 (iPhone; CPU iPhone OS 26_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) HygoReactNative/0.2.0 8.1.0",
