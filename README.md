<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="docs/public/hygo/horizontal_white.svg">
    <source media="(prefers-color-scheme: light)" srcset="docs/public/hygo/horizontal_black.svg">
    <img src="docs/public/hygo/horizontal_black.svg" height="70" alt="Hygo">
  </picture>
    <p align="center">Open Source Web & Product Analytics</p>

<p align="center">
    <a href="https://hygo.ai" target="_blank">Website</a> |
    <a href="https://demo.hygo.ai/81" target="_blank">Demo</a> |
    <a href="https://hygo.ai/docs" target="_blank">Documentation</a> |
    <a href="https://discord.gg/DEhGb4hYBj" target="_blank">Discord</a> |
    <a href="https://github.com/hygo-ai/hygo?tab=AGPL-3.0-1-ov-file" target="_blank">License (AGPL-3)</a> |
    <a href="https://github.com/hygo-ai/hygo/blob/master/CONTRIBUTE.md" target="_blank">Contribute</a>
</p>

<a href="https://hygo.ai/" target="_blank">Hygo</a> is the modern open source and privacy friendly alternative to Google Analytics. It takes only a couple minutes to setup and is super intuitive to use.

<p align="center">
  <a href="https://www.producthunt.com/products/hygo?embed=true&utm_source=badge-top-post-badge&utm_medium=badge&utm_source=badge-hygo" target="_blank">
    <img src="https://api.producthunt.com/widgets/embed-image/v1/top-post-badge.svg?post_id=1028220&theme=standard&period=daily" alt="Hygo - Open Source Google Analytics Replacement | Product Hunt" width="250" height="54" />
  </a>
</p>

<p align="center">
  <strong><a href="https://demo.hygo.ai/81">🔍 View Live Demo</a></strong> - See Hygo running on a real-life production site.
</p>
...
There are two ways to start using Hygo:

| Option                                                   | Description                                                   |
| -------------------------------------------------------- | ------------------------------------------------------------- |
| **[Hosted Service](https://hygo.ai)**                 | The fastest way to get started                                |
| **[Self-Hosting](https://hygo.ai/docs/self-hosting)** | Deploy and manage Hygo on your own VPS for complete control |

📚 Explore our [documentation](https://hygo.ai/docs) to learn more about installation, configuration, and usage.
...
See how Hygo compares to other analytics solutions:

| Feature                           | Hygo | GA4        | Plausible  | Cloudflare |
| --------------------------------- | ------ | ---------- | ---------- | ---------- |
| **Open Source**                   | ✅     | ❌         | ✅         | ❌         |
| **Self-Hosting**                  | ✅     | ❌         | ✅\*       | ❌         |
