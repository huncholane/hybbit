...
description: Docker cleanup and troubleshooting guide for Hygo
---
...
<Callout type="warn">
**Warning**: This will remove ALL Docker containers, images, and volumes on your system, not just Hygo-related ones. Make sure you don't have other important Docker containers running.
</Callout>
...
### Alternative: Hygo-Specific Cleanup

If you only want to clean up Hygo-related Docker resources without affecting other containers, use these commands instead:

```bash
# Stop and remove Hygo containers
docker-compose down

# Remove Hygo images
docker-compose down --rmi all

# Remove Hygo volumes (this will delete your data!)
docker-compose down --volumes

# Complete Hygo cleanup
docker-compose down --rmi all --volumes --remove-orphans
```

### After Cleanup

Once you've completed the cleanup, you can restart Hygo by following the setup instructions:
...
In our [docker-compose.yml](https://github.com/hygo-ai/hygo/blob/master/docker-compose.yml), we have a config for Clickhouse that suppresses logs. Clickhouse stores a ton of logs in the log tables by default. This will quickly fill up your disk space if left unchecked.
