...
| **Exposure** | When your code reads the flag with `hygo.flag()`, Hygo records an exposure for that variant. Exposures are the denominator for each variant's conversion rate. |
