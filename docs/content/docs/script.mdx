...
description: How to install and configure the Hygo tracking script
---

import { Callout } from 'fumadocs-ui/components/callout';

To start tracking user activity on your website, add the Hygo tracking script to your site's HTML.
...
```
If you are self-hosting Hygo `app.hygo.ai` will be domain of your Hygo instance.
...
Most tracking options are configured through your site settings in the Hygo dashboard. The script automatically fetches these settings when it loads:
...
The tracking script automatically evaluates client and both-runtime feature flags when it loads. Read evaluated flags from `window.hygo` after the script is ready:
