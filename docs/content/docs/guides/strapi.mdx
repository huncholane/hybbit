---
title: Strapi
description: Integrate Hygo Analytics with your Strapi-powered website
---

import { Callout } from 'fumadocs-ui/components/callout';

Strapi is an open-source headless CMS that provides an API for your content. Since Strapi is headless, you'll add Hygo Analytics to your frontend application rather than to Strapi itself.
