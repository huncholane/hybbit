---
title: Carrd
description: Integrate Hygo Analytics with your Carrd site
---

import { Steps, Step } from 'fumadocs-ui/components/steps';
import { Callout } from 'fumadocs-ui/components/callout';

Carrd is a popular platform for building simple, responsive one-page sites. You can add Hygo Analytics to track visitors on your Carrd site.

<Callout type="warn">
Adding custom code requires a **Carrd Pro** subscription (Pro Standard, Pro Plus, or Pro Max).
</Callout>

## How to Add Hygo to Carrd
...
3. Check "View Page Source" on your live site and search for `hygo`
