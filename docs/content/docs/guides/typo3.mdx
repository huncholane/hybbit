---
title: TYPO3
description: Integrate Hygo Analytics with your TYPO3 sitepackage
---

import { Steps, Step } from 'fumadocs-ui/components/steps';

Integrating Hygo Analytics with your TYPO3 website is straightforward. You'll
typically add the Hygo tracking script to your main sitepackage
...
First, you'll need your Hygo tracking script. You can find this in your Hygo
...
page {
  # ...
  includeJS {
      hygo = https://app.hygo.ai/api/script.js
      hygo.defer = 1
      hygo.data.data-site-id = YOUR_SITE_ID
  }
  # ...
}
```

This creates a new `<script>` tag, loads the hygo script and adds the Site ID
data attribute.
...
It's best practice to store your Hygo Site ID and instance URL in your site
...
- Check your Hygo dashboard for incoming data. It might take a few minutes
  for the first events to appear.
</Step>

</Steps>

That's it! Hygo Analytics is now integrated with your TYPO3 sitepackage and
