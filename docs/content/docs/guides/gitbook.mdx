---
title: GitBook
description: Integrate Hygo Analytics with your GitBook documentation
---

import { Steps, Step } from 'fumadocs-ui/components/steps';
import { Callout } from 'fumadocs-ui/components/callout';

GitBook is a popular platform for creating documentation and knowledge bases. You can add Hygo Analytics to track how visitors use your documentation.

<Callout type="warn">
Custom scripts require a **Pro plan or higher** and a **custom domain** configured for your GitBook space.
</Callout>

## How to Add Hygo to GitBook
