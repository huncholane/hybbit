...
Access your account settings by clicking on "Account" or going to [app.hygo.ai/settings/account](https://app.hygo.ai/settings/account).
...
Generate API keys to access Hygo's analytics endpoints from your applications.
...
<Callout type="warn">
  On Hygo Cloud, API keys require a Standard or Pro plan. On a free plan you'll see an upgrade prompt in place of the creation form.
</Callout>
...
Include your API key in requests to Hygo's API endpoints. See the [API documentation](/docs/api) for available endpoints and usage examples.
