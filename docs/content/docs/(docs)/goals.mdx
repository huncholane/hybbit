...
Events must be tracked using the Hygo tracking script. See [Track Events](/docs/track-events) for setup instructions.
</Tab>
...
Buttons that already use `data-hygo-event` are recorded as custom events instead.
</Tab>
