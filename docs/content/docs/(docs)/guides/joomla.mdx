---
title: Joomla
description: Integrate Hygo Analytics with your Joomla website
---
...
Joomla is a popular open-source content management system. Here's how to add Hygo Analytics to your Joomla site.

## How to Add Hygo to Joomla
...
- **Title**: Hygo Analytics (or any name you prefer)
- **Show Title**: No
