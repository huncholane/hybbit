---
title: BigCommerce
description: Integrate Hygo Analytics with your BigCommerce store
---
...
BigCommerce is a leading e-commerce platform for online stores. You can integrate Hygo Analytics to track visitor behavior and conversions.

## How to Add Hygo to BigCommerce

<Tabs items={['Script Manager (Recommended)', 'Theme Files']}>
<Tab>
### Using Script Manager

The easiest way to add Hygo to BigCommerce is through the Script Manager.
...
- **Name**: Hygo Analytics
- **Description**: Hygo Analytics tracking script
- **Placement**: Head
- **Location**: All pages
...
To get the most out of Hygo with BigCommerce, you can track key e-commerce events like product views and purchases.
...
<script>
(function() {
  function waitForHygo(callback, timeout) {
    var start = Date.now();
    (function check() {
