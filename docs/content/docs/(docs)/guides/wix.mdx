---
title: "Wix"
description: "Integrate Hygo Analytics with your Wix website using custom code snippets."
---

import { Steps, Step } from 'fumadocs-ui/components/steps';
import { Callout } from "fumadocs-ui/components/callout";

Integrating Hygo Analytics with your Wix website involves adding a custom code snippet to your site's tracking tools.
...
- **Paste your Hygo tracking script** into the main code snippet box.
- **Name your code:** Give it a recognizable name, like "Hygo Analytics".
...
After applying the changes, Hygo Analytics should start tracking visitors on your Wix site.
...
That's it! Hygo Analytics is now integrated with your Wix website.