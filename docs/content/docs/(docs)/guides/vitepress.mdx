---
title: VitePress
description: Integrate Hygo Analytics with your VitePress documentation site
---

import { Tabs, Tab } from 'fumadocs-ui/components/tabs';
import { Callout } from 'fumadocs-ui/components/callout';

VitePress is a static site generator powered by Vite and Vue, commonly used for documentation. Here's how to add Hygo Analytics to your VitePress site.

## How to Add Hygo to VitePress

<Tabs items={['Config File (Recommended)', 'Custom Theme']}>
<Tab>
### Using VitePress Config

The simplest way to add Hygo is through your VitePress configuration file.
...
VitePress uses client-side navigation between pages. The Hygo script automatically tracks page views during SPA navigation, so no additional configuration is needed.
