...
description: Deploy Hygo proxy on Vercel with Edge Network caching
---

import { Steps } from 'fumadocs-ui/components/steps';
import { Callout } from 'fumadocs-ui/components/callout';

Vercel makes it easy to proxy Hygo tracking through their Edge Network. If you're using Next.js, follow the [Next.js proxy guide](/docs/proxy-guide/next-js) instead, which is optimized for Next.js applications.
...
**What you'll achieve:**
- Proxy Hygo through Vercel's Edge Network
  ...
  "rewrites": [
    {
      ...
      "destination": "https://app.hygo.ai/api/script.js"
    },
    {
      "source": "/analytics/replay.js",
      "destination": "https://app.hygo.ai/api/replay.js"
    },
    {
      "source": "/analytics/metrics.js",
      "destination": "https://app.hygo.ai/api/metrics.js"
    },
    {
      "source": "/analytics/track",
      "destination": "https://app.hygo.ai/api/track"
    },
    {
      "source": "/analytics/identify",
      "destination": "https://app.hygo.ai/api/identify"
    },
    {
      "source": "/analytics/session-replay/record/:siteId",
      "destination": "https://app.hygo.ai/api/session-replay/record/:siteId"
    },
    {
      "source": "/analytics/site/tracking-config/:siteId",
      "destination": "https://app.hygo.ai/api/site/tracking-config/:siteId"
    }
  ]
}
```
...
```bash
git add vercel.json
git commit -m "Add Hygo proxy configuration"
git push
```
...
3. **Verify in Hygo dashboard**: Data should appear after 1-2 minutes
...
2. Edge server rewrites and proxies to Hygo
...
**Problem**: Requests still go to `app.hygo.ai` directly.
...
// vercel.staging.json (staging)
{
  "rewrites": [
    {
      "source": "/analytics/script.js",
      "destination": "https://staging.hygo.ai/api/script.js"
    }
  ]
}
```
...
```json
// ❌ Wrong - uses redirects (user sees app.hygo.ai)
{
  "redirects": [
    {
      "source": "/analytics/script.js",
