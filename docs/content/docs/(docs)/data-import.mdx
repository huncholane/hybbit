...
The data import feature allows you to migrate your historical analytics data from other platforms to Hygo. This preserves your analytics history when switching from competitors, giving you a complete view of your data without losing valuable insights.

## Supported Platforms

Currently, Hygo supports importing data from:
...
- Continue using Hygo while the import runs
...
**Imported Events**
- Number of events successfully imported into Hygo
