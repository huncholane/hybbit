...
description: Managing your Hygo installation
---
...
Hygo is updated frequently with new features and bug fixes. You can update your installation by running the following commands:
...
<Callout>
If you are using your self-hosted Hygo without anyone else, you can disable new user signups by setting `DISABLE_SIGNUP=true` in the `.env` file at the root of the repository.
</Callout>
...
To help us improve Hygo, self-hosted instances automatically send anonymous usage statistics to our cloud service. This includes:
