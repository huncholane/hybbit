...
description: Breaking changes and migration steps when upgrading to Hygo v1.0
---

import { Callout } from 'fumadocs-ui/components/callout';


This guide covers the breaking changes and migration steps when upgrading to Hygo v1.0.
...
3. **Update to v1.0** using the update script:
   ...
   ./update.sh
   ```
4. **Verify your setup** by checking that your Hygo instance is accessible and functioning correctly
