...
curl -X POST "https://app.hygo.ai/api/sites/1/funnels" \
...
const response = await fetch(
  'https://app.hygo.ai/api/sites/1/funnels',
  {
    method: 'POST',
    headers: {
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://app.hygo.ai/api/sites/1/funnels');
...
uri = URI('https://app.hygo.ai/api/sites/1/funnels')
...
req, _ := http.NewRequest("POST", "https://app.hygo.ai/api/sites/1/funnels", bytes.NewBuffer(jsonBody))
...
let res = client
    .post("https://app.hygo.ai/api/sites/1/funnels")
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://app.hygo.ai/api/sites/1/funnels"))
    .header("Authorization", "Bearer your_api_key_here")
...
var response = await client.PostAsync("https://app.hygo.ai/api/sites/1/funnels", content);
