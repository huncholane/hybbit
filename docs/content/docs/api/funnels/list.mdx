...
<Tabs items={['cURL', 'JavaScript', 'Python', 'PHP', 'Ruby', 'Go', 'Rust', 'Java', '.NET']}>
  <Tab value="cURL">
```bash title="Request"
curl -X GET "https://app.hygo.ai/api/sites/1/funnels" \
...
func main() {
    client := &http.Client{}
    req, _ := http.NewRequest("GET", "https://app.hygo.ai/api/sites/1/funnels", nil)
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let response = client
        .get("https://app.hygo.ai/api/sites/1/funnels")
