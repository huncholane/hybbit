...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://app.hygo.ai/api/track');
...
uri = URI('https://app.hygo.ai/api/track')
...
req, _ := http.NewRequest("POST", "https://app.hygo.ai/api/track", bytes.NewBuffer(jsonBody))
...
let res = client
    .post("https://app.hygo.ai/api/track")
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://app.hygo.ai/api/track"))
    .header("Authorization", "Bearer your_api_key_here")
...
var response = await client.PostAsync("https://app.hygo.ai/api/track", content);
