...
<Tabs items={['cURL', 'JavaScript', 'Python', 'PHP', 'Ruby', 'Go', 'Rust', 'Java', '.NET']}>
  <Tab value="cURL">
```bash title="Request"
curl -X GET "https://app.hygo.ai/api/sites/1/funnels23" \
...
const response = await fetch(
  'https://app.hygo.ai/api/sites/1/funnels23',
  {
    headers: {
...
```php title="Request"
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://app.hygo.ai/api/sites/1/funnels23');
...
uri = URI('https://app.hygo.ai/api/sites/1/funnels23')
...
func main() {
    client := &http.Client{}
    req, _ := http.NewRequest("GET", "https://app.hygo.ai/api/sites/1/funnels23", nil)
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let response = client
        .get("https://app.hygo.ai/api/sites/1/funnels23")
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://app.hygo.ai/api/sites/1/funnels23"))
    .header("Authorization", "Bearer your_api_key_here")
    .GET()
    .build();
...
<Tabs items={['cURL', 'JavaScript', 'Python', 'PHP', 'Ruby', 'Go', 'Rust', 'Java', '.NET']}>
  <Tab value="cURL">
```bash title="Request"
curl -X POST "https://app.hygo.ai/api/sites/1/funnels/analyze?start_date=2024-01-01&end_date=2024-01-31" \
  -H "Authorization: Bearer your_api_key_here" \
...
```javascript title="Request"
const response = await fetch(
  'https://app.hygo.ai/api/sites/1/funnels/analyze?start_date=2024-01-01&end_date=2024-01-31',
  {
    method: 'POST',
    headers: {
      'Authorization': 'Bearer your_api_key_here',
...
response = requests.post(
    'https://app.hygo.ai/api/sites/1/funnels/analyze',
    params={
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://app.hygo.ai/api/sites/1/funnels/analyze?start_date=2024-01-01&end_date=2024-01-31');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
...
uri = URI('https://app.hygo.ai/api/sites/1/funnels/analyze?start_date=2024-01-01&end_date=2024-01-31')
...
func main() {
    ...
    client := &http.Client{}
    req, _ := http.NewRequest("POST", "https://app.hygo.ai/api/sites/1/funnels/analyze?start_date=2024-01-01&end_date=2024-01-31", bytes.NewBuffer(jsonBody))
    req.Header.Set("Authorization", "Bearer your_api_key_here")
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let client = reqwest::Client::new();
    let response = client
        .post("https://app.hygo.ai/api/sites/1/funnels/analyze?start_date=2024-01-01&end_date=2024-01-31")
        .header("Authorization", "Bearer your_api_key_here")
...
HttpClient client = HttpClient.newHttpClient();
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://app.hygo.ai/api/sites/1/funnels/analyze?start_date=2024-01-01&end_date=2024-01-31"))
    .header("Authorization", "Bearer your_api_key_here")
    .header("Content-Type", "application/json")
...
curl -X POST "https://app.hygo.ai/api/sites/1/funnels/2/sessions?mode=dropped&page=1" \
  -H "Authorization: Bearer your_api_key_here" \
  -H "Content-Type: application/json" \
  -d '{
    "steps": [
...
const response = await fetch(
  'https://app.hygo.ai/api/sites/1/funnels/3/sessions?mode=reached&page=1',
  {
    method: 'POST',
    headers: {
      'Authorization': 'Bearer your_api_key_here',
...
response = requests.post(
    'https://app.hygo.ai/api/sites/1/funnels/2/sessions23',
    params={
        'mode': 'dropped',
        'page': 1
    },
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://app.hygo.ai/api/sites/1/funnels/2/sessions?mode=dropped&page=1');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
curl_setopt($ch, CURLOPT_POST, true);
curl_setopt($ch, CURLOPT_POSTFIELDS, json_encode($body));
curl_setopt($ch, CURLOPT_HTTPHEADER, [
...
uri = URI('https://app.hygo.ai/api/sites/1/funnels/2/sessions?mode=dropped&page=1')
request = Net::HTTP::Post.new(uri)
request['Authorization'] = 'Bearer your_api_key_here'
request['Content-Type'] = 'application/json'
request.body = {
...
req, _ := http.NewRequest("POST", "https://app.hygo.ai/api/sites/1/funnels/2/sessions?mode=dropped&page=1", bytes.NewBuffer(jsonBody))
req.Header.Set("Authorization", "Bearer your_api_key_here")
req.Header.Set("Content-Type", "application/json")
...
let client = reqwest::Client::new();
let res = client
    .post("https://app.hygo.ai/api/sites/1/funnels/2/sessions?mode=dropped&page=1")
    .header("Authorization", "Bearer your_api_key_here")
    .json(&body)
    .send()
    .await?;
...
HttpClient client = HttpClient.newHttpClient();
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://app.hygo.ai/api/sites/1/funnels/2/sessions?mode=dropped&page=1"))
    .header("Authorization", "Bearer your_api_key_here")
    .header("Content-Type", "application/json")
    .POST(HttpRequest.BodyPublishers.ofString(json))
    .build();
...
var response = await client.PostAsync(
    "https://app.hygo.ai/api/sites/1/funnels/2/sessions?mode=dropped&page=1",
    content);
var data = await response.Content.ReadAsStringAsync();
```
  </Tab>
...
curl -X POST "https://app.hygo.ai/api/sites/1/funnels23" \
  -H "Authorization: Bearer your_api_key_here" \
  -H "Content-Type: application/json" \
  -d '{
...
req, _ := http.NewRequest("POST", "https://app.hygo.ai/api/sites/1/funnels23", bytes.NewBuffer(jsonBody))
req.Header.Set("Authorization", "Bearer your_api_key_here")
req.Header.Set("Content-Type", "application/json")
...
let client = reqwest::Client::new();
let res = client
    .post("https://app.hygo.ai/api/sites/1/funnels23")
    .header("Authorization", "Bearer your_api_key_here")
    .json(&body)
    .send()
    .await?;
...
var response = await client.PostAsync("https://app.hygo.ai/api/sites/1/funnels23", content);
var data = await response.Content.ReadAsStringAsync();
```
  </Tab>
</Tabs>
...
<Tabs items={['cURL', 'JavaScript', 'Python', 'PHP', 'Ruby', 'Go', 'Rust', 'Java', '.NET']}>
  <Tab value="cURL">
```bash title="Request"
curl -X DELETE "https://app.hygo.ai/api/sites/1/funnels/123" \
  -H "Authorization: Bearer your_api_key_here"
```
  </Tab>
  <Tab value="JavaScript">
```javascript title="Request"
const response = await fetch(
  'https://app.hygo.ai/api/sites/1/funnels/123',
  {
    method: 'DELETE',
    headers: {
      'Authorization': 'Bearer your_api_key_here'
...
```php title="Request"
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://app.hygo.ai/api/sites/1/funnels/123');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
...
uri = URI('https://app.hygo.ai/api/sites/1/funnels/123')
...
```
  ...
  <Tab value="Go">
```go title="Request"
req, _ := http.NewRequest("DELETE", "https://app.hygo.ai/api/sites/1/funnels/123", nil)
req.Header.Set("Authorization", "Bearer your_api_key_here")
...
let client = reqwest::Client::new();
let res = client
    .delete("https://app.hygo.ai/api/sites/1/funnels/123")
    .header("Authorization", "Bearer your_api_key_here")
    .send()
    .await?;
...
HttpClient client = HttpClient.newHttpClient();
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://app.hygo.ai/api/sites/1/funnels/123"))
    .header("Authorization", "Bearer your_api_key_here")
    .DELETE()
    .build();
...
var response = await client.DeleteAsync("https://app.hygo.ai/api/sites/1/funnels/123");
var data = await response.Content.ReadAsStringAsync();
```
  </Tab>
</Tabs>
