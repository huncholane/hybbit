...
description: Authentication, common parameters, and best practices for the Hygo Stats API
---
...
The easiest way to explore and test the API is using the built-in **API Playground** in your Hygo dashboard. Access it by navigating to any site and clicking "API Playground" in the sidebar.
...
Hygo has two kinds of API keys:
...
1. Navigate to **Settings → Organization** in your Hygo dashboard
