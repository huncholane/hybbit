---
title: Quick start
description: Set up your own instance of Hygo using our setup script
---

import { Steps, Step } from 'fumadocs-ui/components/steps';
import { Callout } from 'fumadocs-ui/components/callout';

This guide will walk you through setting up your own instance of Hygo using our setup script. If you want to manually setup Hygo using the Docker Compose file, check out our [Manual Docker Compose Setup](/docs/self-hosting-guides/self-hosting-manual) guide.
