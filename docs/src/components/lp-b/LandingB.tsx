...
const faqBSchema = {
  ...
  mainEntity: [
    [
      "Is Hygo GDPR and CCPA compliant?",
      "Yes, Hygo is fully compliant with GDPR, CCPA, and other privacy regulations. We don't use cookies or collect any personal data that could identify your users. We salt user IDs daily to ensure users are not fingerprinted. You will not need to display a cookie consent banner to your users.",
    ],
    [
      "How does Hygo compare to Google Analytics?",
      "It's one dashboard instead of 150+ reports, and the script is 18 KB against GA4's 371 KB.",
    ],
    [
      "Where is my data stored?",
      "On Hygo Cloud, hosted in European data centers. Hygo runs the infrastructure, updates, scaling and backups. You add the script and read the dashboard.",
    ],
    [
      "How easy is it to set up Hygo?",
      "Add one script tag to your site, or install @hygo/js from npm. Most sites are collecting data in under 5 minutes.",
    ],
    [
      "What platforms does Hygo support?",
      "The script tag works anywhere you can add HTML: WordPress, Shopify, Next.js, React, Vue, and the rest. For apps, install @hygo/js from npm.",
    ],
    [
      "Is Hygo truly open source?",
    ...
    [
      "Does Hygo have an API?",
      "Yes. The Hygo API exposes every metric the dashboard shows over HTTP, so you can pull your data into your own apps, dashboards, or workflows.",
    ],
...
export function LandingB() {
  ...
  const privacyCards = [
    ...
    },
    {
      ...
      description: t(
        "Hygo Cloud runs in European data centers. Infrastructure, updates, scaling and backups are handled for you."
      ),
      href: "/pricing",
      ...
      <div className="overflow-clip bg-white text-neutral-950 dark:bg-neutral-950 dark:text-neutral-50">
        ...
        <section className={cn(CONTAINER, "flex flex-col gap-6 pt-16 md:pt-24")}>
          <h1 className="max-w-[900px] text-[clamp(2.25rem,4.2vw,3.25rem)] font-medium leading-[1.12] tracking-[-0.035em] text-balance">
            {t("Hygo is the cookieless replacement for Google Analytics.")}
          </h1>
        ...
        <section className={cn(CONTAINER, "mt-12 md:mt-14")} aria-label={t("Live demo of the Hygo dashboard")}>
          <HeroPlate />
        </section>
        ...
        <div className={cn(CONTAINER, "mt-20 flex flex-col gap-6 md:mt-24")}>
          ...
          <Panel>
            <PanelCopy
              ...
              description={t(
                "Browse each session with its device, browser, location and full event timeline, then filter with a click. Identify a user once and Hygo links their whole history, from anonymous first visit to latest session."
              )}
              links={[
          ...
          <Panel visualFirst>
            <div className="flex flex-col justify-center gap-5">
              ...
              <p className="max-w-[44ch] text-base leading-relaxed text-neutral-600 dark:text-neutral-400">
                {t(
                  "A hosted MCP server on top of Hygo's full REST API. Your agent reads live traffic, debugs errors, and manages goals, with the same permissions as a teammate."
                )}
              </p>
        ...
        >
          <div className="flex flex-col gap-3">
            ...
            <p className="text-base leading-relaxed text-neutral-600 dark:text-neutral-400">
              {t("The questions people ask before adding Hygo to their site.")}
            </p>
          </div>
          <FaqB />
        </section>
