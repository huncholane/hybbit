...
export function CTASection({
  ...
  return (
    <section className="group relative overflow-hidden border-b border-emerald-900 bg-emerald-950 text-white">
      ...
      <div className="relative mx-auto grid max-w-[1200px] border-x border-white/10 bare:max-w-[1280px] bare:border-x-0 bare:px-5 bare:sm:px-8 lg:grid-cols-12">
        ...
        <div className="relative z-10 border-b border-white/10 px-5 py-16 bare:border-b-0 bare:px-0 bare:py-14 sm:px-8 bare:sm:px-0 md:py-24 lg:col-span-8 lg:border-b-0 lg:border-r lg:px-10 bare:lg:col-span-7 bare:lg:border-r-0 bare:lg:px-0">
          <h2 className="max-w-3xl text-4xl font-semibold leading-[1.02] tracking-[-0.035em] md:text-6xl text-balance">
            {resolvedTitle}
          </h2>
        </div>

        <div className="relative z-10 flex flex-col justify-center px-5 py-12 bare:px-0 bare:pb-14 bare:pt-0 sm:px-8 bare:sm:px-0 lg:col-span-4 lg:px-10 bare:lg:col-span-5 bare:lg:py-12 bare:lg:pl-10 bare:lg:pr-0">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row lg:flex-col xl:flex-row">
            <TrackedButton
              ...
              className="group inline-flex min-h-11 items-center justify-center gap-2 rounded-md bg-white px-5 py-2.5 text-sm font-medium text-emerald-950 transition-colors duration-200 hover:bg-emerald-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-emerald-950 bare:rounded-full bare:px-6"
            >
            ...
            <TrackedButton
              ...
              className="group inline-flex min-h-11 items-center justify-center gap-2 rounded-md border border-white/25 px-5 py-2.5 text-sm font-medium text-white transition-colors duration-200 hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white bare:rounded-full bare:px-6"
            >
