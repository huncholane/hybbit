...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Hygo is far less bloated than Google Analytics, both in the tracking script and the dashboard. It's one dashboard instead of 150+ reports, and the script is 18KB against GA4's 371KB.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes. You can run Hygo on your own server with Docker and keep full control of your data, or use the managed cloud if you'd rather not host it yourself.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Add one script tag to your site, or install @hygo/js from npm. Most sites are collecting data in under 5 minutes.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "The script tag works anywhere you can add HTML: WordPress, Shopify, Next.js, React, Vue, and the rest. For apps, install @hygo/js from npm.",
      },
    },
    {
      "@type": "Question",
  ...
  const capabilityIndex = [
    ...
    },
    {
      ...
      links: [
        ...
        { label: t("Open source"), href: "https://github.com/hygo-ai/hygo", external: true },
      ],
    },
  ];

  // Note: only include tweets whose claims about the product are accurate
  // (e.g. no "free plan/tier" tweets — Hygo has a trial, not a free tier).
  const tweetColumns = [
          ...
          <div className="relative mx-auto grid max-w-[1200px] border-x border-neutral-200 dark:border-neutral-800 lg:grid-cols-12">
            ...
            <div className="border-b border-neutral-200 px-5 py-16 dark:border-neutral-800 sm:px-8 md:py-24 lg:col-span-4 lg:border-b-0 lg:border-r lg:px-10">
              <div className="lg:sticky lg:top-24">
                ...
                <p className="mt-6 max-w-sm text-base leading-7 text-neutral-600 dark:text-neutral-400">
                  {t("Install Hygo on the platform you already use. Most integrations take only a few minutes.")}
                </p>
            ...
            <div className="grid border-b border-neutral-200 dark:border-neutral-800 md:grid-cols-3">
              ...
              <div className="flex flex-col justify-between px-5 py-10 sm:px-8 md:py-20 lg:px-10">
                <p className="max-w-md text-base leading-7 text-neutral-600 dark:text-neutral-400 text-pretty">
                  {t("What teams say after replacing heavier analytics products with Hygo.")}
                </p>
