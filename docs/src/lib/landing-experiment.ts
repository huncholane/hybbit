 ...
 * `HOME_VARIANT_B_PATH` (URL unchanged). Every visitor's Hygo script tag
 * carries the matching `data-tag` (see `HygoScript`), so both arms can be
...
export const HOME_VARIANT_COOKIE = "hygo_home_variant";
