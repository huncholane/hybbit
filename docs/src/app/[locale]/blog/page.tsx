...
export const metadata: Metadata = {
  ...
  description:
    "Tutorials and insights from the Hygo team on web analytics, Google Analytics alternatives, privacy-first tracking, and building in the open.",
  alternates: {
    canonical: "https://hygo.ai/blog",
  },
  openGraph: {
    title: "Hygo Blog",
    description:
...
export default function BlogPage() {
  ...
  return (
    <div className="overflow-x-clip">
      <InteriorPageHero
        title="Blog"
        description="Updates, tutorials, and insights from the Hygo team — on analytics, privacy, and building in the open."
