...
const pageTitle = "Hygo for European Companies | EU-Hosted, Cookieless Analytics";
...
export const metadata = createMetadata({
  ...
  alternates: {
    canonical: "https://hygo.ai/for-european-companies",
  },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    url: "https://hygo.ai/for-european-companies",
    images: [createOGImageUrl("Hygo for European Companies", "EU-hosted, cookieless, compliant by design.", "Solutions")],
  },
  twitter: {
    images: [createOGImageUrl("Hygo for European Companies", "EU-hosted, cookieless, compliant by design.", "Solutions")],
  },
...
const faqItems = [
  {
    question: "Is Hygo GDPR and CCPA compliant?",
    answer:
      "Yes. Hygo doesn't use cookies or collect personal data that could identify visitors, and user IDs are salted daily so nobody can be fingerprinted. You won't need to show a cookie consent banner for analytics.",
  },
  {
    question: "Where is the cloud hosted?",
    answer:
      "Hygo's cloud is EU-hosted. If your requirements go further than that, you can self-host the entire product on infrastructure you control, in any region you choose.",
  },
  {
    question: "Do you offer a Data Processing Agreement?",
    answer:
      "Yes. Hygo provides a DPA (see hygo.ai/dpa). Dedicated isolated instances and on-premise installation are available on the Enterprise plan for stricter setups.",
  },
  {
    question: "Do visitors need to consent before Hygo runs?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Yes. Hygo is open source under AGPL v3. The full product self-hosts with Docker on your own servers, which is the strongest data-residency answer there is.",
  },
];
...
const complianceRows = [
  {
    ...
    description: "Hygo's managed cloud is EU-hosted, so the default option is already the compliant one.",
  },
  {
    title: "No cookies, no banner",
    description:
      "Hygo collects no personal data and sets no cookies, so analytics doesn't trigger a consent requirement on your sites.",
  },
  {
...
export default function ForEuropeanCompaniesPage() {
  return (
    <div className="overflow-x-clip">
      <InteriorPageHero
        eyebrow="Hygo for European companies"
        ...
        <div className="relative mx-auto grid max-w-[1200px] grid-cols-1 border-x border-neutral-200 dark:border-neutral-800 lg:grid-cols-12">
          ...
          <div className="border-b border-neutral-200 px-5 py-14 dark:border-neutral-800 sm:px-8 lg:col-span-7 lg:border-b-0 lg:border-r lg:px-10 md:py-20">
            ...
            <p className="mt-6 max-w-xl text-base leading-7 text-neutral-600 dark:text-neutral-400">
              Hygo is 100% open source under AGPL v3 and self-hosts with Docker. For regulated setups, Enterprise
