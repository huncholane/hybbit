...
const pageTitle = "Hygo for SaaS | Funnels, Retention, and Sessions in One Tool";
...
export const metadata = createMetadata({
  ...
  alternates: {
    canonical: "https://hygo.ai/for-saas",
  },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    url: "https://hygo.ai/for-saas",
    images: [createOGImageUrl("Hygo for SaaS", "See the funnel. Then watch the sessions inside it.", "Solutions")],
  },
  twitter: {
    images: [createOGImageUrl("Hygo for SaaS", "See the funnel. Then watch the sessions inside it.", "Solutions")],
  },
...
const faqItems = [
  {
    question: "Is Hygo web analytics or product analytics?",
    answer:
  ...
  {
    question: "Does Hygo do feature flags and A/B tests?",
    answer:
  ...
  },
  {
    ...
    answer:
      "No. Hygo is cookieless and doesn't collect personal data that could identify visitors, so it's GDPR and CCPA compliant without a consent banner, in the app and on the marketing site.",
  },
  {
    question: "We're on Plausible or Umami. Do we lose our history?",
    answer:
      "No. Hygo imports historical data from Plausible, Umami, and Simple Analytics (up to 36 months on Standard and 60 months on Pro), so your growth charts keep their past.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. Hygo is open source under AGPL v3: self-host the full product on your own infrastructure with unlimited events, or start on cloud and move later. The workflow is identical either way.",
  },
];
          ...
          <div className="border-t border-neutral-200 px-5 py-10 dark:border-neutral-800 sm:px-8 lg:px-10">
            <div className="grid grid-cols-1 gap-10 lg:grid-cols-2">
              <p className="max-w-lg text-base leading-7 text-neutral-600 dark:text-neutral-400">
                ...
                schemas, two logins, and an integration that quietly drifts. Hygo covers the whole path (first visit
                to retained account) in one schema, so answering &ldquo;which channel brings users who stick?&rdquo;
                takes one filter. If you&apos;re weighing the heavier route, see how Hygo compares to{" "}
                <Link
              ...
              <p className="max-w-lg text-base leading-7 text-neutral-600 dark:text-neutral-400">
                ...
                your own app and a tracking gap wherever users decline. Hygo is cookieless and collects no personal
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12">
            ...
            <div className="flex items-end px-5 py-10 sm:px-8 md:py-20 lg:col-span-5 lg:px-10">
              <p className="max-w-md text-lg leading-8 text-neutral-600 text-pretty dark:text-neutral-400">
                ...
                gets made, the events never ship. Hygo inverts it: autocapture first, naming later.
              </p>
            </div>
          </div>
      ...
      <section className="border-b border-neutral-200 dark:border-neutral-800" aria-labelledby="saas-ship-title">
        <div className="relative mx-auto max-w-[1200px] border-x border-neutral-200 dark:border-neutral-800">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12">
            ...
            <div className="flex items-end px-5 py-10 sm:px-8 md:py-20 lg:col-span-5 lg:px-10">
              <p className="max-w-md text-lg leading-8 text-neutral-600 text-pretty dark:text-neutral-400">
                The measure-ship-measure loop usually spans three tools. In Hygo, the flag that gates the feature and
        ...
        <div className="relative mx-auto grid max-w-[1200px] grid-cols-1 border-x border-neutral-200 dark:border-neutral-800 lg:grid-cols-12">
          ...
          <div className="border-b border-neutral-200 px-5 py-14 dark:border-neutral-800 sm:px-8 lg:col-span-7 lg:border-b-0 lg:border-r lg:px-10 md:py-20">
            ...
            <p className="mt-6 max-w-xl text-base leading-7 text-neutral-600 dark:text-neutral-400">
              Hygo is 100% open source under AGPL v3, with API access and data export on every plan. Start on cloud
