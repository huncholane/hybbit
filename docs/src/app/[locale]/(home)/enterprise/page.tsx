...
const pageTitle = "Hygo for Enterprise | Open-Source Analytics Your Security Team Can Read";
...
export const metadata = createMetadata({
  ...
  alternates: {
    canonical: "https://hygo.ai/enterprise",
  },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    url: "https://hygo.ai/enterprise",
    images: [
      createOGImageUrl("Hygo for Enterprise", "Open-source analytics your security team can read.", "Solutions"),
    ],
  },
  twitter: {
    images: [
...
const faqItems = [
  {
    question: "Can we run Hygo on our own infrastructure?",
    answer:
  ...
  {
    question: "Does Hygo support Single Sign-On?",
  ...
  },
  {
    ...
    answer:
      "Yes. A DPA is available at hygo.ai/dpa, alongside a public security page. The cloud is EU-hosted, and visitor tracking is cookieless with daily-salted IDs.",
  },
  {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12">
            ...
            <div className="flex flex-col justify-center px-5 py-10 sm:px-8 md:py-20 lg:col-span-5 lg:px-10">
              <p className="max-w-md text-lg leading-8 text-neutral-600 text-pretty dark:text-neutral-400">
                Every line of Hygo, including the cloud and enterprise code, is public on GitHub under AGPL v3. Your
