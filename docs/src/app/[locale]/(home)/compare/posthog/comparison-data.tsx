...
export const posthogComparisonData: ComparisonSection[] = [
  {
    ...
    features: [
      ...
      { name: "Saved segments", hygoValue: true, competitorValue: "Cohorts" },
...
export const posthogExtendedData = {
  ...
  introParagraphs: [
    ...
    "Hygo takes the opposite approach: do web analytics well instead of doing everything adequately. The single-page dashboard gives your whole team the metrics they need, with no training required. Non-technical team members can understand user behavior, track conversions, and watch session replays without learning a query language or navigating dozens of menus.",
  ...
  deepDive: {
    title: "PostHog vs Hygo, in depth",
    sections: [
      {
        ...
        paragraphs: [
          ...
          <>
            ...
            a lot of menus between you and &ldquo;how much traffic did we get this week?&rdquo; Hygo makes the
      ...
      },
      {
        ...
        paragraphs: [
          ...
          <>
            ...
            their dashboards. Hygo&apos;s <Link href="/pricing">pricing</Link>{" "}
      ...
      },
      {
        ...
        paragraphs: [
          <>
            Both tools are open source, but their out-of-the-box privacy postures differ. Hygo is cookieless by
      ...
      {
        heading: "Running PostHog and Hygo together",
        paragraphs: [
          <>
            This doesn&apos;t have to be an either/or decision. A setup we see often: keep PostHog for what it&apos;s
            uniquely good at (feature flags, experiments, and SQL access to raw events) and run Hygo as
            ...
            full PostHog toolkit. The two scripts don&apos;t conflict, and Hygo&apos;s flat plan means the second
  ...
  faqItems: [
    {
      ...
      answer: "Hygo focuses exclusively on web analytics with a clean, simple interface. PostHog is a full product suite with analytics, feature flags, A/B testing, surveys, and more. If you primarily need web analytics, Hygo delivers a faster, simpler experience.",
    },
    {
      question: "Is Hygo really simpler than PostHog?",
      answer: "Yes. Hygo provides a single-page dashboard where all essential metrics are visible on one screen. PostHog's extensive feature set means more menus, more configuration, and a steeper learning curve, especially for non-technical team members.",
    },
    {
      question: "Does PostHog have features Hygo doesn't?",
      answer: "Yes, PostHog offers feature flags, A/B testing, surveys, heatmaps, and a SQL query interface that Hygo doesn't have. These are useful tools for product teams, but they add complexity. Hygo intentionally focuses on doing web analytics well.",
    },
    {
