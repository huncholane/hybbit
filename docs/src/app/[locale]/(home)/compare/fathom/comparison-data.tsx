    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          <>
            ...
            traffic numbers from the most stable, boring vendor possible, and deliberately stops there. Hygo
      ...
      },
      {
        ...
        paragraphs: [
          ...
          <>
            Hygo covers the same dashboard basics, then adds the layer Fathom deliberately leaves out:{" "}
            ...
            tracking</Link>, Web Vitals monitoring, and user profiles. Hygo&apos;s script is bigger (~18KB) because
            it does more. That&apos;s the honest trade. There&apos;s also an ownership difference with no
            trade-off attached: Hygo is open source and can be{" "}
      ...
      },
      {
        ...
        paragraphs: [
          ...
          <>
            Hygo prices on events instead, starting at{" "}
      ...
      {
        heading: "Switching from Fathom to Hygo",
        paragraphs: [
          <>
            Hygo&apos;s historical-data importers currently cover Plausible, Umami, and Simple Analytics;
            there is no Fathom importer yet. So the switch is the classic parallel run:
          </>,
          <ol>
            <li>
              Add the Hygo <Link href="/docs/script">tracking script</Link> alongside Fathom&apos;s. The two
              don&apos;t conflict, and data appears in minutes.
            </li>
            <li>
              Recreate your Fathom events and conversions as Hygo <Link href="/docs/goals">goals</Link> and{" "}
