    ...
    <>
      ...
      <div className="overflow-x-clip">
        <InteriorPageHero
          ...
          title="Hygo vs The Competition"
          description="See how Hygo stacks up against every major analytics platform. Privacy-first, open source, and built for modern teams."
        ...
        <section className="border-b border-neutral-200 dark:border-neutral-800" aria-labelledby="comparison-directory-title">
          <div className="mx-auto grid max-w-[1200px] border-x border-neutral-200 dark:border-neutral-800 lg:grid-cols-12">
            ...
            {competitors.map((competitor) => (
              ...
              >
                <div>
                  <p className="text-xs font-medium uppercase tracking-[0.12em] text-neutral-400">Hygo vs</p>
