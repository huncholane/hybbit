...
export const umamiComparisonData: ComparisonSection[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Starting price", hygoValue: "$19/mo", competitorValue: "Free (Hobby)" },
    ],
  },
];
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          <>
            Hygo makes the other bet: a full analytics platform that happens to also be open source. Alongside the
            ...
            raises a question. In Umami the report is where the trail ends. In Hygo you can open the sessions behind
      ...
      },
      {
        ...
        paragraphs: [
          <>
            ...
            stats at $0 that is genuinely hard to beat. Hygo starts at $19/mo for 100k events with a 7-day trial,
            and every plan includes every feature. Per event, Umami Pro is cheaper; what you&apos;re paying Hygo for
          ...
          <>
            ...
            MySQL database you probably already know how to run. Hygo&apos;s{" "}
            ...
            trade; if you want the full platform on your own hardware, Hygo&apos;s setup is still a single Docker
            install.
          </>,
        ],
      },
      {
        heading: "Switching from Umami to Hygo",
        paragraphs: [
          <>
            Unlike most analytics migrations, you don&apos;t have to start from zero: Hygo ships a data importer for
          ...
          <ol>
            <li>
              Add the Hygo tracking script and leave Umami running. Both are lightweight and cookieless, and the two
            ...
            <li>
              ...
              <Link href="/docs">docs</Link> for the walkthrough) so your Hygo dashboard starts with
              continuity instead of a blank chart.
            </li>
            <li>
              Recreate your custom events and goals. Umami&apos;s event model maps cleanly onto Hygo&apos;s custom
      ...
      },
      {
        ...
        paragraphs: [
          <>
            ...
            answer; Hygo&apos;s extra features would sit unused. The same goes if you want the lightest
