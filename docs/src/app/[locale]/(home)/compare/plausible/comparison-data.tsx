...
export const plausibleComparisonData: ComparisonSection[] = [
  {
    ...
    features: [
      ...
      { name: "Funnels", hygoValue: "All plans", competitorValue: "Business plan only" },
  ...
  },
  {
    ...
    features: [
      { name: "Script size", hygoValue: "18KB", competitorValue: "~5KB" },
      { name: "Bypasses ad blockers", hygoValue: true, competitorValue: true },
      { name: "API access", hygoValue: true, competitorValue: true },
      { name: "Starting price", hygoValue: "$19/mo", competitorValue: "$9/mo" },
    ],
  },
];

export const plausibleExtendedData = {
  subtitle: "Both are privacy-first, but Hygo offers session replay, funnels, and user journeys that Plausible doesn't.",

  introHeading: "Why consider Hygo over Plausible?",
  introParagraphs: [
  ...
  deepDive: {
    title: "Plausible vs Hygo, in depth",
    sections: [
      {
        ...
        paragraphs: [
          ...
          <>
            Hygo starts from the same privacy foundation (cookieless tracking with a daily-rotating salt, open
            ...
            came from; Hygo also shows you what visitors did once they arrived, where they dropped off, and what
            broke.
          </>,
        ],
      },
      {
        ...
        paragraphs: [
          ...
          <>
            Hygo prices by events (from $19/month for 100k events), and every plan includes every
            ...
            Community Edition and Hygo&apos;s open-source version are each free to self-host.
          </>,
        ],
      },
      {
        heading: "Switching from Plausible to Hygo",
        paragraphs: [
          <>
            This is one migration where you don&apos;t start from zero: Hygo has a built-in data importer for
            Plausible, so your historical traffic comes with you instead of living in an old dashboard forever.
          </>,
          <ol>
            <li>
              Add the Hygo tracking script alongside Plausible&apos;s. Both are lightweight, and running them
            ...
            <li>Recreate your goals as Hygo goals and custom events; the setup is similarly simple.</li>
            <li>
      ...
      },
      {
        ...
        paragraphs: [
          <>
            ...
            famously tiny script (Plausible advertises it as 54&times; smaller than Google Analytics; Hygo&apos;s is
            around 18KB), and a 30-day trial with no card required versus Hygo&apos;s 7 days. Choosing it means
  ...
  faqItems: [
    {
      question: "How is Hygo different from Plausible?",
      answer: "Both are privacy-first and open source, but Hygo includes advanced features that Plausible doesn't offer: session replay, funnel analysis, user journey visualization (Sankey diagrams), Web Vitals monitoring, error tracking, and user profiles.",
    },
    {
      question: "Is Hygo as easy to use as Plausible?",
      answer: "Yes. Hygo is designed to be just as simple for basic analytics, with a clean single-page dashboard. The advanced features like funnels and session replay are there when you need them but don't add complexity to the core experience.",
    },
    {
      question: "How does pricing compare between Hygo and Plausible?",
      answer: "Plausible starts at $9/month for 10k pageviews, while Hygo starts at $19/month. The key difference is that Hygo uses events-based pricing (which includes pageviews, custom events, and more) and includes advanced features like session replay, funnels, and error tracking that Plausible doesn't offer at any price.",
    },
    {
      question: "Can I self-host Hygo like Plausible?",
      answer: "Yes, Hygo is fully self-hostable under the AGPL v3 license. Both use ClickHouse for fast analytics queries. Hygo's stack is TypeScript-based, while Plausible uses Elixir.",
    },
    {
      question: "Does Hygo have session replay?",
      answer: "Yes, session replay is one of the biggest differentiators. Hygo offers session replay on the Pro plan, allowing you to watch how users interact with your site. Plausible does not offer this feature at any price point.",
    },
  ] satisfies FAQItem[],
