...
export const googleAnalyticsComparisonData: ComparisonSection[] = [
  {
    ...
    features: [
      ...
      { name: "Saved segments", hygoValue: true, competitorValue: "Explorations only" },
...
export const googleAnalyticsExtendedData = {
  ...
  deepDive: {
    title: "Google Analytics vs Hygo, in depth",
    sections: [
      {
        ...
        paragraphs: [
          ...
          <>
            ...
            $50,000 per year. Hygo&apos;s <Link href="/pricing">pricing</Link> is a flat, events-based subscription:
      ...
      },
      {
        ...
        paragraphs: [
          <>
            ...
            other way for product and marketing teams: Hygo ships{" "}
          ...
          <>
            ...
            for ad attribution while running Hygo as your source of truth for real traffic is a reasonable setup;
            the two scripts don&apos;t conflict.
          </>,
        ],
      },
      {
        heading: "How to switch from Google Analytics to Hygo",
        paragraphs: [
          <>
          ...
          <ol>
            <li>
              Add the Hygo <Link href="/docs/script">tracking script</Link>: one tag, and data appears in
              minutes. Keep GA4 running alongside it.
            </li>
            <li>
              Recreate your conversions as Hygo <Link href="/docs/goals">goals</Link> and{" "}
            ...
            <li>
              Compare a few weeks of numbers. Expect Hygo to report noticeably more traffic. That&apos;s the
      ...
      },
      {
        ...
        paragraphs: [
          <>
            ...
            Analytics transfers violated GDPR, and enforcement keeps tightening. Hygo sidesteps the whole category of
  ...
  faqItems: [
    {
      ...
      answer: "Hygo uses a single script tag, so add it to your site and you'll start collecting data immediately. There's no need to remove GA4 right away; you can run both in parallel to compare.",
    },
    {
    ...
    },
    {
      ...
      answer: "Yes, Hygo provides real-time data with no sampling. Unlike GA4 which may sample data on high-traffic properties, Hygo shows every event as it happens.",
    },
  ] satisfies FAQItem[],
  ...
  relatedResources: [
    {
      ...
      description: "How Hygo and 8 other GA4 alternatives compare on pricing, privacy, and features",
    },
    {
