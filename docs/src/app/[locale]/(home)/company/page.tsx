...
const description = "Legal entity and contact information for the company operating Hygo";
...
const companyDetails = [
  ...
  },
  {
    ...
    label: "Contact",
    value: (
      <a href="mailto:hello@hygo.ai" className="font-medium">
        hello@hygo.ai
      </a>
    ),
  },
...
export default function CompanyInformation() {
  return (
    <LegalPageShell
      title="Company Information"
      intro="The legal and contact details for the company behind Hygo."
    >
      <p>
        Hygo is operated by <strong>Tomato.gg LLC</strong>, a United States limited liability company.
      </p>
      ...
      <h2 className="mt-10 text-2xl font-semibold">About Hygo</h2>
      <p>
        Hygo is an open-source, privacy-friendly web and product analytics platform. Tomato.gg LLC provides the
        hosted Hygo service and related customer support.
      </p>
      ...
      <p>
        ...
        <a href="mailto:hello@hygo.ai">hello@hygo.ai</a>.
      </p>
    </LegalPageShell>
  );
}
