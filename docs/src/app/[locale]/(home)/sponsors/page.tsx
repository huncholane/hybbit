...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      createOGImageUrl(
        "Hygo Sponsors",
        "Meet the sponsors who support Hygo, the open-source privacy-first analytics platform."
      ),
    ],
  },
  twitter: {
  ...
  return (
    <div className="overflow-x-clip">
      <InteriorPageHero
        ...
        title="Our Sponsors"
        description="Thank you to the amazing companies that support Hygo&apos;s development."
