...
const pageTitle = "Hygo for Startups | Growth Answers Without a Data Team";
...
export const metadata = createMetadata({
  ...
  alternates: {
    canonical: "https://hygo.ai/for-startups",
  },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    url: "https://hygo.ai/for-startups",
    images: [createOGImageUrl("Hygo for Startups", "Growth answers without a data team.", "Solutions")],
  },
  twitter: {
    images: [createOGImageUrl("Hygo for Startups", "Growth answers without a data team.", "Solutions")],
  },
...
const faqItems = [
  {
    ...
    answer:
      "Most teams are live in under five minutes: add one script tag or install @hygo/js from npm, and pageviews, clicks, and sessions start flowing immediately. Funnels and goals are configured in the dashboard, not in code.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Not yet. Most teams run Hygo alongside their old analytics for a few weeks, then switch once they trust the numbers. Your Hygo history builds from the day you install.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "No. Hygo doesn't use cookies or collect personal data, so it's GDPR and CCPA compliant without a consent banner. You also see all of your traffic, including the visitors who would have clicked decline.",
  },
  {
...
const firstWeek = [
  {
    ...
    description:
      "One script tag on your marketing site and app, or @hygo/js from npm. Pageviews, clicks, outbound links, and errors are captured automatically. No instrumentation plan required.",
  },
  {
    step: 2,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12">
            ...
            <div className="flex items-end px-5 py-10 sm:px-8 md:py-20 lg:col-span-5 lg:px-10">
              <p className="max-w-md text-lg leading-8 text-neutral-600 text-pretty dark:text-neutral-400">
                ...
                come from?), not a discipline someone owns. Hygo is built for the person answering that question
          ...
          <div className="grid grid-cols-1 gap-px bg-neutral-200 dark:bg-neutral-800 lg:grid-cols-12">
            <article className="bg-white px-5 py-10 dark:bg-neutral-950 sm:px-8 lg:col-span-7 lg:px-10">
              ...
              <p className="mt-2 max-w-lg text-sm leading-6 text-neutral-600 dark:text-neutral-400">
                ...
                And because Hygo is cookieless, the Hacker News crowd running ad blockers still shows up in your
                numbers.
              </p>
