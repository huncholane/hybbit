...
const pageTitle = "Hygo for Ecommerce | See Every Step From Ad Click to Checkout";
...
export const metadata = createMetadata({
  ...
  alternates: {
    canonical: "https://hygo.ai/for-ecommerce",
  },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    url: "https://hygo.ai/for-ecommerce",
    images: [createOGImageUrl("Hygo for Ecommerce", "See every step between ad click and checkout.", "Solutions")],
  },
  twitter: {
    images: [createOGImageUrl("Hygo for Ecommerce", "See every step between ad click and checkout.", "Solutions")],
  },
...
const faqItems = [
  {
    question: "Does Hygo work with Shopify and WooCommerce?",
    answer:
      "Yes. Hygo works with Shopify, WooCommerce, BigCommerce, PrestaShop, Squarespace, Wix, and any platform that lets you add a script tag. Most store platforms take a few minutes to set up.",
  },
  {
  ...
  {
    question: "Does Hygo have a revenue report?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Consent banners and ad blockers stop cookie-based analytics from seeing a large share of visitors. Hygo doesn't use cookies or collect personal data, so it isn't gated behind a consent choice. You see the whole audience.",
  },
  {
    question: "Will the tracking script slow my store down?",
    answer:
      "The script loads async, so it doesn't block your pages from rendering. Hygo also measures web vitals from real visits and shows your store's speed by page and device.",
  },
  {
    question: "Do I need a cookie consent banner for Hygo?",
    answer:
      "No. Hygo is GDPR and CCPA compliant without a consent banner, because it doesn't use cookies or collect personal data that could identify your shoppers.",
  },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12">
            ...
            <div className="flex items-end px-5 py-10 sm:px-8 md:py-20 lg:col-span-5 lg:px-10">
              <p className="max-w-md text-lg leading-8 text-neutral-600 text-pretty dark:text-neutral-400">
                ...
                reality as consent rates fall. Hygo doesn&apos;t sit behind that choice. The campaign you&apos;re
