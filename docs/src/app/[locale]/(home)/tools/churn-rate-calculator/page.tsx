...
export const metadata: Metadata = {
  title: "Free Churn Rate Calculator | Hygo",
  description:
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://hygo.ai/tools/churn-rate-calculator",
    siteName: "Hygo",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://hygo.ai/tools/churn-rate-calculator",
  },
};
...
const faqData = [
  ...
  {
    question: "How can Hygo help investigate churn?",
    answer:
      "Hygo can show funnels, retention, journeys, events, and session replays leading up to cancellation or disengagement. Those behavioral signals help teams form and test specific churn-reduction hypotheses.",
  },
];
...
export default function ChurnRateCalculatorPage() {
  return (
    <ToolPageLayout
      ...
      ctaDescription="Use Hygo funnels, retention reports, events, and session replays to understand where customers disengage."
