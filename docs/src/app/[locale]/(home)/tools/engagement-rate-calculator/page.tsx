...
export const metadata: Metadata = {
  title: "Free Engagement Rate Calculator | Hygo",
  description:
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://hygo.ai/tools/engagement-rate-calculator",
    siteName: "Hygo",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://hygo.ai/tools/engagement-rate-calculator",
  },
};
...
const faqData = [
  ...
  {
    question: "Can Hygo measure engagement after a social click?",
    answer:
      "Yes. Hygo can track the website sessions, goals, events, and conversions that follow a social visit. That ties platform engagement to real on-site behavior.",
  },
];
...
export default function EngagementRateCalculatorPage() {
  return (
    <ToolPageLayout
      ...
      ctaDescription="Use Hygo to connect campaign traffic with website events, goals, and conversions without adding analytics clutter."
