...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://hygo.ai/tools/nps-calculator",
    siteName: "Hygo",
  },
  twitter: {
  ...
  alternates: { canonical: "https://hygo.ai/tools/nps-calculator" },
};
...
const faqs = [
  ...
  {
    question: "Can Hygo help explain a change in NPS?",
    answer:
      "Hygo does not collect NPS responses by default, but its privacy-friendly web analytics can help you compare product journeys, conversions, and behavior around the periods or segments where your survey score changed.",
  },
];
