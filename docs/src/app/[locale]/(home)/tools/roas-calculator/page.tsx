...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://hygo.ai/tools/roas-calculator",
    siteName: "Hygo",
  },
  twitter: {
  ...
  alternates: { canonical: "https://hygo.ai/tools/roas-calculator" },
};
...
const faqs = [
  ...
  {
    question: "How can Hygo support ROAS analysis?",
    answer:
      "Hygo can capture campaign parameters, conversions, and customer journeys without relying on invasive visitor profiles. Pair consistent campaign tracking with your ad-platform costs and revenue source to evaluate performance.",
  },
];
  ...
  "@graph": [
    {
      ...
      author: { "@type": "Organization", name: "Hygo", url: "https://hygo.ai" },
    },
    {
      "@type": "FAQPage",
