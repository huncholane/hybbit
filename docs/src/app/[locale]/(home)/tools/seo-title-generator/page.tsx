    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Use analytics to track CTR from search results. Tools like Hygo can show you which pages get the most organic traffic and which titles are working.",
          },
        },
        {
          "@type": "Question",
