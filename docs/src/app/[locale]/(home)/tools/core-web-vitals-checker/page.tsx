...
const canonicalUrl = "https://hygo.ai/tools/core-web-vitals-checker";
const description =
...
export const metadata: Metadata = {
  title: "Free Core Web Vitals Checker | Hygo",
  description,
...
const faqs = [
  ...
  {
    question: "Does Hygo measure real-user web performance?",
    answer:
      "Hygo focuses on privacy-friendly website and product analytics. Use this checker for an on-demand PageSpeed snapshot, then monitor your own releases and traffic patterns to connect performance changes with user behavior.",
  },
];
  ...
  "@graph": [
    {
      ...
      creator: { "@type": "Organization", name: "Hygo", url: "https://hygo.ai" },
    },
    {
      "@type": "FAQPage",
