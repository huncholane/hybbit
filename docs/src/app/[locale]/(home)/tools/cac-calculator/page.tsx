...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://hygo.ai/tools/cac-calculator",
    siteName: "Hygo",
  },
  twitter: {
  ...
  alternates: { canonical: "https://hygo.ai/tools/cac-calculator" },
};
...
const faqs = [
  ...
  {
    question: "How can Hygo support CAC measurement?",
    answer:
      "Hygo can measure campaign visits, conversions, funnels, and acquisition journeys. Combine those counts with your advertising and operating costs, keeping channel definitions and attribution windows consistent between systems.",
  },
];
