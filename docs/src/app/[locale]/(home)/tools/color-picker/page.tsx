...
export const metadata: Metadata = {
  title: "Free Color Picker and Contrast Checker | Hygo",
  description:
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://hygo.ai/tools/color-picker",
    siteName: "Hygo",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://hygo.ai/tools/color-picker",
  },
};
...
export default function ColorPickerPage() {
  return (
    <ToolPageLayout
      ...
      ctaDescription="Hygo keeps website data clear, focused, and accessible across light and dark themes."
