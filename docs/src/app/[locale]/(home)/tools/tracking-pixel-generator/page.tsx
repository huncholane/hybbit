...
const canonicalUrl = "https://hygo.ai/tools/tracking-pixel-generator";
const description =
...
export const metadata: Metadata = {
  title: "Free Tracking Pixel Generator | Hygo",
  description,
...
export default function TrackingPixelGeneratorPage() {
  return (
    <ToolPageLayout
      ...
      ctaDescription="Hygo turns privacy-friendly pageviews and events into clear journeys, funnels, and conversion insights."
