...
export const metadata: Metadata = {
  title: "Free MRR and ARR Calculator | Hygo",
  description:
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://hygo.ai/tools/mrr-arr-calculator",
    siteName: "Hygo",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://hygo.ai/tools/mrr-arr-calculator",
  },
};
...
const faqData = [
  ...
  {
    question: "How can Hygo support recurring revenue analysis?",
    answer:
      "Hygo can measure acquisition funnels, product events, cohorts, and retention behavior around subscription growth. Pair those signals with billing data to understand the customer actions behind recurring-revenue changes.",
  },
];
...
export default function MRRARRCalculatorPage() {
  return (
    <ToolPageLayout
      ...
      ctaDescription="Use Hygo to understand the funnels, events, and retention patterns behind subscription acquisition and churn."
