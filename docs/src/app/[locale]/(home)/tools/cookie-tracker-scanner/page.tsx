...
const canonicalUrl = "https://hygo.ai/tools/cookie-tracker-scanner";
const description =
...
export const metadata: Metadata = {
  title: "Free Cookie & Tracker Scanner | Hygo",
  description,
        ...
        acceptedAnswer: {
          ...
          text:
            typeof faq.answer === "string"
              ? faq.answer
              : "Reduce unnecessary tracking, document each cookie's purpose, and consider cookieless analytics such as Hygo.",
        },
      })),
    },
  ],
...
export default function CookieTrackerScannerPage() {
  return (
    <ToolPageLayout
      ...
      ctaDescription="Hygo gives you clear website analytics with a lightweight, cookieless script and privacy-friendly defaults."
