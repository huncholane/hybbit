...
const pageTitle = "Web Analytics for Small Businesses | Hygo";
...
export const metadata = createMetadata({
  ...
  alternates: {
    canonical: "https://hygo.ai/for-small-business",
  },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    url: "https://hygo.ai/for-small-business",
    images: [
      createOGImageUrl(
...
const faqItems = [
  {
    question: "Can I try Hygo before paying?",
    answer:
      "Yes. Every plan starts with a 7-day free trial with all features included, and you won't be charged until the trial ends. Hygo is also open source, so self-hosting it yourself is always free.",
  },
  {
    question: "Do I need a cookie consent banner?",
    answer:
      "No. Hygo is cookieless and doesn't collect personal data, so it's GDPR and CCPA compliant without a consent banner on your site.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "That's the whole idea. Hygo shows visitors, where they came from, your top pages, and your goals on a single screen you can read at a glance. No analyst and no GA4 walkthrough needed.",
  },
  {
...
export default function ForSmallBusinessPage() {
  return (
    <div className="overflow-x-clip">
      <InteriorPageHero
        eyebrow="Hygo for small businesses"
        title="The numbers your business needs. Nothing you don't."
        description="You don't need a data team to know if your website is working. Hygo puts visitors, sources, top pages, and goals on one screen you can read in thirty seconds. No GA4 maze, no cookie banner, and a free trial to start."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12">
            ...
            <div className="flex items-end px-5 py-10 sm:px-8 md:py-20 lg:col-span-5 lg:px-10">
              <p className="max-w-md text-lg leading-8 text-neutral-600 text-pretty dark:text-neutral-400">
                ...
                (is the website bringing people in?) and no interest in learning a reporting tool to answer it. Hygo
...
></script>`}</code>
            ...
            <article className="bg-white px-5 py-10 dark:bg-neutral-950 sm:px-8 lg:col-span-5 lg:px-10">
              ...
              <p className="mt-2 max-w-md text-sm leading-6 text-neutral-600 dark:text-neutral-400">
                Hygo is cookieless and GDPR- and CCPA-compliant out of the box, so your site doesn&apos;t need a
        ...
        <div className="relative mx-auto grid max-w-[1200px] grid-cols-1 border-x border-neutral-200 dark:border-neutral-800 lg:grid-cols-12">
          ...
          <div className="border-b border-neutral-200 px-5 py-14 dark:border-neutral-800 sm:px-8 lg:col-span-7 lg:border-b-0 lg:border-r lg:px-10 md:py-20">
            ...
            <p className="mt-6 max-w-xl text-base leading-7 text-neutral-600 dark:text-neutral-400">
              Hygo is built so the owner of the business can read it, no marketing hire needed. And because it&apos;s
