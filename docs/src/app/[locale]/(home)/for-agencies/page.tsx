...
const pageTitle = "Hygo for Agencies | Client-Friendly Web Analytics";
...
export const metadata = createMetadata({
  ...
  alternates: {
    canonical: "https://hygo.ai/for-agencies",
  },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    url: "https://hygo.ai/for-agencies",
    images: [createOGImageUrl("Hygo for Agencies", "Every client site in one workspace, on dashboards clients can actually read.", "Solutions")],
  },
  twitter: {
    images: [createOGImageUrl("Hygo for Agencies", "Every client site in one workspace, on dashboards clients can actually read.", "Solutions")],
  },
...
const faqItems = [
  {
    question: "Can my clients see their dashboard without a Hygo account?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Yes. Hygo imports historical data from Plausible, Umami, and Simple Analytics: up to 36 months on Standard and 60 months on Pro, with no limits when self-hosting. Clients switching to you don't lose their history.",
  },
  {
  ...
  {
    question: "Do client sites need a cookie consent banner for Hygo?",
    answer:
      "No. Hygo doesn't use cookies or collect personal data, so it's GDPR and CCPA compliant without a consent banner.",
  },
  {
    question: "Do clients get reports automatically?",
    answer:
      "Yes. Hygo sends automatic weekly email reports summarizing analytics performance, so clients get their numbers in the inbox without you exporting anything.",
  },
  {
    question: "Can I white-label Hygo for my clients?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Nothing is locked in: Hygo is open source, with API access and data export on every plan. Worst case, they can self-host the exact same product.",
  },
];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12">
              ...
              <div className="flex items-end px-5 py-10 sm:px-8 md:py-20 lg:col-span-5 lg:px-10">
                <p className="max-w-md text-lg leading-8 text-neutral-600 text-pretty dark:text-neutral-400">
                  ...
                  explain it. Hygo puts sessions, sources, and conversions on one screen that stays legible to
            ...
            <div className="border-t border-neutral-200 px-5 py-10 dark:border-neutral-800 sm:px-8 lg:px-10">
              <div className="grid grid-cols-1 gap-10 lg:grid-cols-2">
                ...
                <p className="max-w-lg text-base leading-7 text-neutral-600 dark:text-neutral-400">
                  ...
                  banner and a consent-declined blind spot in its numbers. Hygo is cookieless, so the sites you
          ...
          <div className="relative mx-auto max-w-[1200px] border-x border-neutral-200 dark:border-neutral-800">
            ...
            <div className="grid grid-cols-1 gap-px bg-neutral-200 dark:bg-neutral-800 lg:grid-cols-12">
              ...
              <article className="bg-white px-5 py-10 dark:bg-neutral-950 sm:px-8 lg:col-span-7 lg:px-10">
                ...
                <p className="mt-2 max-w-lg text-sm leading-6 text-neutral-600 dark:text-neutral-400">
                  Hygo is cookieless and compliant with GDPR and CCPA out of the box, so the sites you build
        ...
        >
          <div className="relative mx-auto max-w-[1200px] border-x border-neutral-200 dark:border-neutral-800">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12">
              ...
              <div className="flex items-end px-5 py-10 sm:px-8 md:py-20 lg:col-span-5 lg:px-10">
                <p className="max-w-md text-lg leading-8 text-neutral-600 text-pretty dark:text-neutral-400">
                  The worst part of switching analytics for a whole roster is the empty dashboards on day one. Hygo
          ...
          <div className="relative mx-auto grid max-w-[1200px] grid-cols-1 border-x border-neutral-200 dark:border-neutral-800 lg:grid-cols-12">
            ...
            <div className="border-b border-neutral-200 px-5 py-14 dark:border-neutral-800 sm:px-8 lg:col-span-7 lg:border-b-0 lg:border-r lg:px-10 md:py-20">
              ...
              <p className="mt-6 max-w-xl text-base leading-7 text-neutral-600 dark:text-neutral-400">
                Hygo is 100% open source under AGPL v3. If you or a client ever want out of the cloud, self-host the
