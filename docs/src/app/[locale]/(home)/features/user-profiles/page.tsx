...
export const metadata: Metadata = {
  title: "User Profiles - Hygo | User Identification & Traits",
  description:
  ...
  alternates: {
    canonical: "https://hygo.ai/features/user-profiles",
  },
};
...
const structuredData = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      "@id": "https://hygo.ai/features/user-profiles",
      name: "Hygo User Profiles",
      description:
  ...
  return (
    <>
      ...
      <FeaturePage
        ...
        demoUrl="https://demo.hygo.ai/81/users"
        ...
        introParagraphs={[
          ...
          <>
            Identification is <strong className="text-neutral-900 dark:text-white">completely opt-in and privacy-first</strong>. Users are only identified when you explicitly call <code className="bg-neutral-200 dark:bg-neutral-800 px-1.5 py-0.5 rounded text-sm">hygo.identify()</code>. There&apos;s no fingerprinting, no cross-site tracking, and no passive data collection. You decide exactly what information to attach: plan type, company, role, or any custom trait.
          </>,
          <>
