...
export const metadata: Metadata = {
  title: "Retention - Hygo | Cohort Retention Analysis",
  description:
  ...
  alternates: {
    canonical: "https://hygo.ai/features/retention",
  },
};
...
const structuredData = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      "@id": "https://hygo.ai/features/retention",
      name: "Hygo Retention Analysis",
  ...
  return (
    <>
      ...
      <FeaturePage
        ...
        badgeText="Retention"
        demoUrl="https://demo.hygo.ai/81/retention"
        ...
        introParagraphs={[
          ...
          <>
            Hygo&apos;s retention analysis groups users into <strong className="text-neutral-900 dark:text-white">cohorts by their first visit date</strong> and tracks what percentage return on each subsequent day or week. The result is a color-coded heatmap that makes it instantly obvious whether your retention is improving, degrading, or holding steady.
          </>,
          <>
