...
export const howItWorks: HowItWorksStep[] = [
  ...
  },
  {
    ...
    description:
      "As visitors browse your site, their actual LCP, FID/INP, and CLS values are measured and sent to Hygo. No synthetic tests, just real performance from real users.",
  },
  {
    step: 3,
