...
export const metadata: Metadata = createMetadata({
  ...
  openGraph: {
    images: [createOGImageUrl("Features - Hygo Analytics", "Real-time traffic, session replay, funnels, web vitals, and error tracking, from one cookieless script.", "Features")],
  },
  twitter: {
    images: [createOGImageUrl("Features - Hygo Analytics", "Real-time traffic, session replay, funnels, web vitals, and error tracking, from one cookieless script.", "Features")],
  },
