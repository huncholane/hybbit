...
export const howItWorks: HowItWorksStep[] = [
  {
    ...
    description:
      "Point your MCP client at https://app.hygo.ai/api/mcp (or your own domain if you self-host). Per-client walkthroughs cover Claude Code, Cursor, Codex, Claude Desktop, VS Code, and opencode.",
  },
  {
    step: 2,
    title: "Authenticate",
...
export const faqItems: FAQItem[] = [
  {
    ...
    answer:
      "Any MCP client that supports Streamable HTTP. Hygo has step-by-step guides for Claude Code, Claude Desktop, Cursor, Codex, VS Code, and opencode, and a generic configuration for everything else.",
  },
  {
    question: "Is my analytics data sent to an AI provider?",
    answer:
      "Not by Hygo. The server contains no AI model and never sends your data to one. Data only leaves Hygo in response to the MCP client you configure, so which model sees it is entirely determined by the client you connect.",
  },
  {
  ...
  {
    question: "Does it work on self-hosted Hygo?",
    answer:
