...
export const metadata: Metadata = {
  title: "MCP Server - Hygo | Analytics for AI Assistants",
  description:
  ...
  alternates: {
    canonical: "https://hygo.ai/features/mcp",
  },
};
...
const structuredData = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      "@id": "https://hygo.ai/features/mcp",
      name: "Hygo MCP Server",
      description:
        "Hosted Model Context Protocol server that connects AI assistants to Hygo analytics.",
      url: "https://hygo.ai/features/mcp",
      isPartOf: {
        "@type": "WebSite",
        name: "Hygo",
  ...
  return (
    <>
      ...
      <FeaturePage
        ...
        subtitle="Hygo's hosted MCP server connects Claude, Cursor, Codex, and any MCP client to your analytics: query traffic, manage goals and funnels, even run read-only SQL, with the same permissions as your dashboard."
        badgeText="MCP Server"
        introParagraphs={[
          <>
            Dashboards answer the questions someone thought to build. The Hygo{" "}
          ...
          <>
            ...
            <strong className="text-neutral-900 dark:text-white">OAuth or scoped, revocable API keys</strong>, and every tool call is authorized against your role, site access, and rate limits. Hygo runs no AI model of its own. Your data goes only to the client you configure, on cloud or self-hosted.
          </>,
        ]}
