    ...
    <>
      ...
      <FeaturePage
        ...
        introParagraphs={[
          ...
          <>
            Custom events <strong className="text-neutral-900 dark:text-white">feed the rest of Hygo</strong>: use them as funnel steps, goal triggers, and filter conditions. Paired with autocapture (which records clicks and form submissions on its own), most of your behavioral data arrives with <strong className="text-neutral-900 dark:text-white">little instrumentation</strong>.
          </>,
        ]}
