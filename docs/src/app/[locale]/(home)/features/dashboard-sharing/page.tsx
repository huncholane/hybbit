...
export const metadata: Metadata = {
  title: "Dashboard Sharing - Hygo | Public Dashboards, Private Links & Embeds",
  description:
  ...
  alternates: {
    canonical: "https://hygo.ai/features/dashboard-sharing",
  },
};
...
const structuredData = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      "@id": "https://hygo.ai/features/dashboard-sharing",
      name: "Hygo Dashboard Sharing",
      description:
  ...
  return (
    <>
      ...
      <FeaturePage
        ...
        demoUrl="https://demo.hygo.ai/81"
        demoCaption="This demo is a public Hygo dashboard: exactly what viewers see when you share yours"
        introParagraphs={[
          <>
            Analytics that only you can log into is analytics going to waste. Clients want to see the campaign working, communities want proof of traction, and your own site might deserve a live visitor counter. Hygo gives you{" "}
          ...
          <>
            ...
            <strong className="text-neutral-900 dark:text-white">private link</strong>: a secret URL that gives clients and stakeholders the live dashboard without a Hygo account, and without exposing anything publicly.
          </>,
          <>
