...
export const capabilities: FeatureCapability[] = [
  ...
  },
  {
    ...
    description:
      "Drop your entire analytics dashboard into any site with a single iframe. Light, dark, or system theme, optional sidebar, and the Hygo footer hidden automatically.",
  },
  {
...
export const howItWorks: HowItWorksStep[] = [
  ...
  },
  {
    ...
    description:
      "For embeds, Hygo generates the iframe snippet for you. Paste it into any site: no JavaScript, no tracking script dependency, and the widget is server-cached so it won't add load.",
  },
  {
    step: 4,
...
export const faqItems: FAQItem[] = [
  {
    question: "Do viewers need a Hygo account?",
    answer:
  ...
  {
    question: "Does this work on self-hosted Hygo?",
    answer:
      "Yes. All sharing options work identically when self-hosting. The embed snippets simply use your own domain instead of app.hygo.ai.",
  },
];
