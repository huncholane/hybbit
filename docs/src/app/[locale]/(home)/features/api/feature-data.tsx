...
export const capabilities: FeatureCapability[] = [
  ...
  },
  {
    ...
    description:
      "POST pageviews, custom events, errors, and performance data from your backend, mobile app, or anything that speaks HTTP. Hygo resolves geolocation and parses user agents for you.",
  },
  {
...
export const whoUses: WhoUsesItem[] = [
  {
    ...
    description:
      "Surface analytics inside your own product: show creators their post views or customers their campaign stats, powered by live Hygo data.",
  },
  {
