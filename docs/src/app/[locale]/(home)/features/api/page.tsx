...
export const metadata: Metadata = {
  title: "Analytics API - Hygo | REST API for Your Analytics Data",
  description:
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://hygo.ai/features/api",
    images: [
      createOGImageUrl(
        "Analytics API",
  ...
  alternates: {
    canonical: "https://hygo.ai/features/api",
  },
};
...
const structuredData = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      "@id": "https://hygo.ai/features/api",
      name: "Hygo Analytics API",
      description:
  ...
  return (
    <>
      ...
      <FeaturePage
        ...
        subtitle="A REST API over everything Hygo collects: query any metric, ingest events from any platform, and pull raw data into your own systems. Prototype it all in the built-in playground."
        badgeText="Analytics API"
        introParagraphs={[
          <>
            Your analytics shouldn&apos;t be locked inside a dashboard. The Hygo API exposes{" "}
