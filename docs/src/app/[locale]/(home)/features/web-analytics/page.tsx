...
export const metadata: Metadata = {
  title: "Web Analytics - Hygo | Privacy-First Website Analytics",
  description:
  ...
  alternates: {
    canonical: "https://hygo.ai/features/web-analytics",
  },
};
...
const structuredData = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      "@id": "https://hygo.ai/features/web-analytics",
      name: "Hygo Web Analytics",
      description:
