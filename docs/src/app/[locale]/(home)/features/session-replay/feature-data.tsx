...
export const howItWorks: HowItWorksStep[] = [
  ...
  },
  {
    ...
    description:
      "Every user interaction (clicks, scrolls, page navigations, masked form inputs, and custom events) is captured and sent to your Hygo instance.",
  },
  {
    step: 4,
...
export const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Hygo session replay is integrated directly into your analytics platform: no separate tool, no extra billing, and no data silos. It's also privacy-first with automatic input masking, and it's fully open source: you can self-host everything.",
  },
  {
