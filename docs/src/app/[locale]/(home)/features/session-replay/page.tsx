...
export const metadata: Metadata = {
  title: "Session Replay - Hygo | Watch Real User Sessions",
  description:
  ...
  alternates: {
    canonical: "https://hygo.ai/features/session-replay",
  },
};
...
const structuredData = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      "@id": "https://hygo.ai/features/session-replay",
      name: "Hygo Session Replay",
      description:
  ...
  return (
    <>
      ...
      <FeaturePage
        ...
        demoUrl="https://demo.hygo.ai/81/replay"
        ...
        introParagraphs={[
          ...
          <>
            Unlike standalone tools like Hotjar or FullStory, Hygo&apos;s session replay is <strong className="text-neutral-900 dark:text-white">built directly into your analytics platform</strong>. There&apos;s no separate tool to manage, no additional billing, and no data silos. Filter your analytics by any dimension, then watch the matching sessions.
          </>,
          <>
            Privacy comes first. Sensitive form inputs are <strong className="text-neutral-900 dark:text-white">automatically masked</strong>, the capture script loads asynchronously with <strong className="text-neutral-900 dark:text-white">zero performance impact</strong>, and because Hygo is open source, you can self-host everything and keep full control over your data. No third-party ever touches your replays.
          </>,
        ]}
