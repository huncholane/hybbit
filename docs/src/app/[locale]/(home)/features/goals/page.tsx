...
export const metadata: Metadata = {
  title: "Goals - Hygo | Conversion Goal Tracking",
  description:
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://hygo.ai/features/goals",
    images: [
      createOGImageUrl(
        "Conversion Goals",
  ...
  alternates: {
    canonical: "https://hygo.ai/features/goals",
  },
};
...
const structuredData = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      "@id": "https://hygo.ai/features/goals",
      name: "Hygo Goals",
  ...
  return (
    <>
      ...
      <FeaturePage
        ...
        badgeText="Goals"
        demoUrl="https://demo.hygo.ai/81/goals"
        demoCaption="Live goals demo — real conversion tracking data"
        introParagraphs={[
          <>
            Every website has a purpose — a signup, a purchase, a download, a contact form submission. <strong className="text-neutral-900 dark:text-white">Goals let you track these conversions</strong> with a single click. No tag managers, no conversion pixels, no third-party scripts. Just define what success looks like and Hygo does the rest.
          </>,
          <>
