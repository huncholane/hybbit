    ...
    <>
      ...
      <FeaturePage
        ...
        introParagraphs={[
          ...
          <>
            Goals work alongside the rest of Hygo. Filter your goals by any dimension (traffic source, country, device) to understand <strong className="text-neutral-900 dark:text-white">which segments convert best</strong>. Pair with funnels to see the path to conversion, and session replay to watch what happens when users <em>don&apos;t</em> convert.
          </>,
        ]}
