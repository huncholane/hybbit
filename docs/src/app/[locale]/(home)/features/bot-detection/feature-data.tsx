...
export const howItWorks: HowItWorksStep[] = [
  ...
  },
  {
    ...
    description:
      "User-agent patterns, header heuristics, client signals, ASN checks, and rate anomaly detection all run on every incoming tracking request. Hygo records every layer that matched, then makes one final decision.",
  },
  {
    step: 3,
