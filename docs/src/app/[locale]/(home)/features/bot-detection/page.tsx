...
export const metadata: Metadata = {
  title: "Bot Detection - Hygo | Block & Inspect Bot Traffic",
  description:
  ...
  alternates: {
    canonical: "https://hygo.ai/features/bot-detection",
  },
};
...
const structuredData = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      "@id": "https://hygo.ai/features/bot-detection",
      name: "Hygo Bot Detection",
  ...
  return (
    <>
      ...
      <FeaturePage
        ...
        subtitle="Five detection layers filter crawlers, scrapers, headless browsers, and AI agents before they pollute your data. And unlike silent filters, Hygo shows you everything it blocked."
        badgeText="Bot Detection"
        demoUrl="https://demo.hygo.ai/81/bots"
        demoCaption="Live bot report: real bot traffic detected and filtered on this site"
        introParagraphs={[
          <>
            A meaningful share of your traffic isn&apos;t human: search crawlers, uptime monitors, scrapers, link previewers, and a fast-growing wave of AI agents. Left in your data, they inflate visitor counts, distort bounce rates, and quietly wreck conversion metrics. Hygo checks{" "}
          ...
          <>
            Most analytics tools filter bots silently against a user-agent list, so you never know what was removed, or what slipped through. Hygo stores a compact record of every filtered request and gives you a{" "}
