  ...
  return (
    <div className="bg-white dark:bg-neutral-950">
      ...
      >
        ...
        <img src={pngPath} alt={`Hygo ${variant.name} logo`} className="max-h-full max-w-full object-contain" />
      </div>
  ...
  return (
    <div className="overflow-x-clip">
      <InteriorPageHero
        title={t("Brand Kit")}
        description={t(
          "Download official Hygo logos and assets. All logos are available in SVG and PNG formats for use in your projects, integrations, and content."
        )}
