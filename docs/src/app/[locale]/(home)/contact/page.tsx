...
export default function Contact() {
  ...
  return (
    <div className="overflow-x-clip">
      <InteriorPageHero
        title={t("Contact Us")}
        description={t("Have questions about Hygo? Reach out through any of these channels:")}
        ...
        <div className="relative mx-auto max-w-[1200px] border-x border-neutral-200 dark:border-neutral-800">
          ...
          <div className="grid gap-px bg-neutral-200 dark:bg-neutral-800 md:grid-cols-2">
            ...
            <div className="bg-white px-5 py-10 dark:bg-neutral-950 sm:px-8 lg:px-10">
              ...
              <p className="mt-3 max-w-md text-base leading-7 text-neutral-600 dark:text-neutral-400">
                {t(
                  "Looking to white-label Hygo for your organization or need a custom analytics solution? We offer tailored implementations to meet your specific requirements."
                )}
              </p>
