...
const pageTitle = "Hygo for Developers | Open-Source, Self-Hostable Analytics";
...
export const metadata = createMetadata({
  ...
  alternates: {
    canonical: "https://hygo.ai/for-developers",
  },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    url: "https://hygo.ai/for-developers",
    images: [createOGImageUrl("Hygo for Developers", "Script tag, SDK, REST API, MCP server, and self-hosting. All open source.", "Solutions")],
  },
  twitter: {
    images: [createOGImageUrl("Hygo for Developers", "Script tag, SDK, REST API, MCP server, and self-hosting. All open source.", "Solutions")],
  },
...
const faqItems = [
  {
    question: "What do I need to self-host Hygo?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Hygo is 100% open source under AGPL v3, including the code for the cloud and enterprise offerings. See the self-hosting vs cloud guide for the practical differences between running it yourself and using the managed cloud.",
  },
  {
    question: "Does Hygo have an SDK?",
    answer:
      "Yes. @hygo/js on npm for websites and web apps, plus Node and React Native SDKs. The plain script tag works anywhere HTML does.",
  },
  {
  ...
  {
    question: "Is Hygo GDPR compliant without a cookie banner?",
    answer:
      "Yes. Hygo doesn't use cookies or collect personal data that could identify visitors, so sites using it don't need a consent banner for analytics.",
  },
];
...
const apiTokens = [
  ...
  {
    text: '"https://app.hygo.ai/api/sites/123/metric?parameter=country&start_date=2026-06-01&end_date=2026-06-30"',
...
const mcpTokens = [
  ...
  { text: "--transport http hygo \\\n  ", className: tokenPlain },
  { text: "https://app.hygo.ai/api/mcp", className: tokenString },
];

const selfHostTokens = [
  { text: "git clone ", className: tokenName },
  { text: "https://github.com/hygo-ai/hygo.git", className: tokenString },
  { text: "\n", className: tokenPlain },
            ...
            <div className="border-b border-neutral-200 px-5 py-14 dark:border-neutral-800 sm:px-8 lg:col-span-4 lg:border-b-0 lg:border-r lg:px-10 md:py-20">
              <div className="lg:sticky lg:top-24">
                ...
                <p className="mt-6 max-w-sm text-base leading-7 text-neutral-600 dark:text-neutral-400">
                  Drop the script on any site, or install @hygo/js and initialize it in two lines. Autocapture
          ...
          <div className="relative mx-auto grid max-w-[1200px] grid-cols-1 border-x border-neutral-200 dark:border-neutral-800 lg:grid-cols-12">
            ...
            <div className="border-b border-neutral-200 px-5 py-14 dark:border-neutral-800 sm:px-8 lg:col-span-4 lg:border-b-0 lg:border-r lg:px-10 md:py-20">
              <div className="lg:sticky lg:top-24">
                ...
                <p className="mt-6 max-w-sm text-base leading-7 text-neutral-600 dark:text-neutral-400">
                  Every metric Hygo shows is available from the REST API with a bearer key. Pull traffic into your
          ...
          <div className="relative mx-auto grid max-w-[1200px] grid-cols-1 border-x border-neutral-200 dark:border-neutral-800 lg:grid-cols-12">
            ...
            <div className="border-b border-neutral-200 px-5 py-14 dark:border-neutral-800 sm:px-8 lg:col-span-4 lg:border-b-0 lg:border-r lg:px-10 md:py-20">
              <div className="lg:sticky lg:top-24">
                ...
                <p className="mt-6 max-w-sm text-base leading-7 text-neutral-600 dark:text-neutral-400">
                  Every line of Hygo is on GitHub under AGPL v3, including the cloud and enterprise features. Clone
