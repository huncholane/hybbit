...
const pageTitle = "Hygo for Creators & Publishers | Know What Resonates";
...
export const metadata = createMetadata({
  ...
  alternates: {
    canonical: "https://hygo.ai/for-creators",
  },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    url: "https://hygo.ai/for-creators",
    images: [createOGImageUrl("Hygo for Creators", "Know what resonates. Skip the surveillance.", "Solutions")],
  },
  twitter: {
    images: [createOGImageUrl("Hygo for Creators", "Know what resonates. Skip the surveillance.", "Solutions")],
  },
...
const faqItems = [
  {
    ...
    answer:
      "No. Hygo doesn't use cookies or collect personal data about your readers, so it's GDPR and CCPA compliant without a consent banner cluttering your site.",
  },
  {
    question: "Will analytics slow my site down?",
    answer:
      "The script loads async, so it doesn't block your pages from rendering. Hygo also measures web vitals from real visits: your site's actual speed, not a guess.",
  },
  {
  ...
  {
    question: "Does Hygo work with my platform?",
    answer:
      "Hygo works anywhere you can add a script tag: WordPress, Ghost, Webflow, Squarespace, Wix, Framer, Hugo, Astro, Jekyll, and every major framework. Most setups take a few minutes.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Standard starts at $13/month billed annually for 100K pageviews, with a 7-day free trial. Hygo is also open source: self-hosting on your own server is free.",
  },
];
...
export default function ForCreatorsPage() {
  return (
    <div className="overflow-x-clip">
      <InteriorPageHero
        eyebrow="Hygo for creators & publishers"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12">
            ...
            <div className="flex items-end px-5 py-10 sm:px-8 md:py-20 lg:col-span-5 lg:px-10">
              <p className="max-w-md text-lg leading-8 text-neutral-600 text-pretty dark:text-neutral-400">
                Free analytics is paid for with your audience's data. Hygo's answer is structural: no cookies, no
