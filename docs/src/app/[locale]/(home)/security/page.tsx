...
export default function Security() {
  return (
    <LegalPageShell
      title="Security"
      intro="Security and privacy are at the core of everything we do at Hygo. Here's how we protect your data and maintain a secure analytics platform."
    >
        ...
        <p>Hygo helps you comply with privacy regulations:</p>
        <ul className="list-disc pl-6 space-y-2">
