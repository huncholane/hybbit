...
const pageTitle = "White Label Web Analytics | Hygo";
...
export const metadata = createMetadata({
  ...
  alternates: {
    canonical: "https://hygo.ai/white-label",
  },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    url: "https://hygo.ai/white-label",
    images: [
      createOGImageUrl(
...
const faqItems = [
  {
    question: "Can I remove Hygo branding from the dashboard?",
    answer:
      "In embed mode the Hygo footer is hidden automatically and you can hide the sidebar, so a client sees a clean, read-only dashboard. Full branding removal, custom domains, and a dedicated instance are available on the Enterprise plan.",
  },
  {
    question: "Can clients see analytics without a Hygo account?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Yes. Choose a light, dark, or system theme, hide the dashboard sidebar to keep viewers on the main page, and the Hygo footer is removed automatically in embed mode.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. Every plan includes API access and a Stats API. Pull the same data Hygo renders into your own portal or client interface and style it however you like.",
  },
  {
    question: "Can I run Hygo entirely under my own domain?",
    answer:
      "Yes. Hygo is open source under AGPL v3. Self-host the full product on your own infrastructure and domain. If you'd rather not run it yourself, Enterprise offers managed dedicated instances.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "That's the model. Analytics you resell under your brand is your product at your price. Hygo charges you by traffic, not per client, so the margin math stays yours as the roster grows.",
  },
  {
...
const embedSnippet = `<iframe
  src="app.hygo.ai/12/PRIVATE_KEY/main?embed=true"
  loading="lazy"
></iframe>`;
...
const workflowSteps = [
  ...
  },
  {
    ...
    body: "Paste the embed snippet into your portal. Pick light, dark, or system theme, hide the sidebar, and the Hygo footer disappears on its own.",
  },
  {
    step: "04",
        ...
        <div className="relative mx-auto max-w-[1200px] border-x border-neutral-200 dark:border-neutral-800">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12">
            ...
            <div className="flex items-end px-5 py-10 sm:px-8 md:py-20 lg:col-span-5 lg:px-10">
              <p className="max-w-md text-lg leading-8 text-neutral-600 text-pretty dark:text-neutral-400">
                ...
                tool they could go buy directly. Hygo is built to disappear behind your product: as an embed, an
          ...
          <div className="border-t border-neutral-200 px-5 py-10 dark:border-neutral-800 sm:px-8 lg:px-10">
            <div className="grid grid-cols-1 gap-10 lg:grid-cols-2">
              ...
              <p className="max-w-lg text-base leading-7 text-neutral-600 dark:text-neutral-400">
                Hygo is priced to be that layer: unlimited websites on Pro under one traffic-priced subscription, so
          ...
          <div className="grid grid-cols-1 gap-px bg-neutral-200 dark:bg-neutral-800 lg:grid-cols-12">
            <article className="bg-white px-5 py-10 dark:bg-neutral-950 sm:px-8 lg:col-span-7 lg:px-10">
              ...
              <p className="mt-2 max-w-lg text-sm leading-6 text-neutral-600 dark:text-neutral-400">
                ...
                and the Hygo footer is removed automatically in embed mode, so it reads as part of your product.
              </p>
            ...
            <article className="bg-white px-5 py-10 dark:bg-neutral-950 sm:px-8 lg:col-span-7 lg:px-10">
              ...
              <p className="mt-2 max-w-lg text-sm leading-6 text-neutral-600 dark:text-neutral-400">
                Hygo is 100% open source under AGPL v3. Self-host the exact same product on your own infrastructure
          ...
          <div className="grid grid-cols-1 border-b border-neutral-200 dark:border-neutral-800 lg:grid-cols-12">
            ...
            <div className="flex items-end px-5 py-10 sm:px-8 md:py-20 lg:col-span-5 lg:px-10">
              <p className="max-w-md text-lg leading-8 text-neutral-600 text-pretty dark:text-neutral-400">
                ...
                instance on Enterprise as the client roster grows. Every step is available without leaving Hygo.
              </p>
            </div>
          </div>
          <div>
        ...
        <div className="relative mx-auto grid max-w-[1200px] grid-cols-1 border-x border-neutral-200 dark:border-neutral-800 lg:grid-cols-12">
          ...
          <div className="border-b border-neutral-200 px-5 py-14 dark:border-neutral-800 sm:px-8 lg:col-span-7 lg:border-b-0 lg:border-r lg:px-10 md:py-20">
            ...
            <p className="mt-6 max-w-xl text-base leading-7 text-neutral-600 dark:text-neutral-400">
              Because Hygo is open source with full API access and data export on every plan, a white-label built on
