 ...
 * Hygo only sees a request if the page ran its script, so a crawler that
  ...
  return (
    <div className="flex items-start gap-2 px-1 text-xs text-neutral-600 dark:text-neutral-400 leading-relaxed">
      ...
      <p>
        ...
        most training crawlers — never reach Hygo unless your server reports them through the tracking API.
      </p>
    </div>
  );
}
