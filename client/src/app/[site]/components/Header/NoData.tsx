...
const PLATFORM_GUIDES: PlatformGuide[] = [
  { title: "WordPress", icon: <SiWordpress className={ICON} />, href: "https://hygo.ai/docs/guides/wordpress" },
  { title: "Shopify", icon: <SiShopify className={ICON} />, href: "https://hygo.ai/docs/guides/shopify" },
  { title: "Next.js", icon: <SiNextdotjs className={ICON} />, href: "https://hygo.ai/docs/guides/react/next-js" },
  { title: "React", icon: <SiReact className={ICON} />, href: "https://hygo.ai/docs/guides/react/vite-cra" },
  {
    title: "Google Tag Manager",
    icon: <SiGoogletagmanager className={ICON} />,
    href: "https://hygo.ai/docs/guides/google-tag-manager",
  },
  { title: "Webflow", icon: <SiWebflow className={ICON} />, href: "https://hygo.ai/docs/guides/webflow" },
  {
    title: "Squarespace",
    icon: <SiSquarespace className={ICON} />,
    href: "https://hygo.ai/docs/guides/squarespace",
  },
  { title: "Wix", icon: <SiWix className={ICON} />, href: "https://hygo.ai/docs/guides/wix" },
  { title: "Framer", icon: <SiFramer className={ICON} />, href: "https://hygo.ai/docs/guides/framer" },
  { title: "Vue", icon: <SiVuedotjs className={ICON} />, href: "https://hygo.ai/docs/guides/vue/vite" },
  { title: "Angular", icon: <SiAngular className={ICON} />, href: "https://hygo.ai/docs/guides/angular" },
  { title: "Astro", icon: <SiAstro className={ICON} />, href: "https://hygo.ai/docs/guides/astro" },
  {
    title: "BigCommerce",
    icon: <SiBigcommerce className={ICON} />,
    href: "https://hygo.ai/docs/guides/bigcommerce",
  },
  { title: "Carrd", icon: <SiCarrd className={ICON} />, href: "https://hygo.ai/docs/guides/carrd" },
  { title: "Contentful", icon: <SiContentful className={ICON} />, href: "https://hygo.ai/docs/guides/contentful" },
  { title: "Docusaurus", icon: <SiDocusaurus className={ICON} />, href: "https://hygo.ai/docs/guides/docusaurus" },
  { title: "Drupal", icon: <SiDrupal className={ICON} />, href: "https://hygo.ai/docs/guides/drupal" },
  { title: "Gatsby", icon: <SiGatsby className={ICON} />, href: "https://hygo.ai/docs/guides/react/gatsby" },
  { title: "Ghost", icon: <SiGhost className={ICON} />, href: "https://hygo.ai/docs/guides/ghost" },
  { title: "GitBook", icon: <SiGitbook className={ICON} />, href: "https://hygo.ai/docs/guides/gitbook" },
  { title: "Hugo", icon: <SiHugo className={ICON} />, href: "https://hygo.ai/docs/guides/hugo" },
  { title: "Jekyll", icon: <SiJekyll className={ICON} />, href: "https://hygo.ai/docs/guides/jekyll" },
  { title: "Joomla", icon: <SiJoomla className={ICON} />, href: "https://hygo.ai/docs/guides/joomla" },
  { title: "Laravel", icon: <SiLaravel className={ICON} />, href: "https://hygo.ai/docs/guides/laravel" },
  { title: "Mintlify", icon: <SiMintlify className={ICON} />, href: "https://hygo.ai/docs/guides/mintlify" },
  { title: "Nuxt", icon: <SiNuxt className={ICON} />, href: "https://hygo.ai/docs/guides/vue/nuxt" },
  { title: "PrestaShop", icon: <SiPrestashop className={ICON} />, href: "https://hygo.ai/docs/guides/prestashop" },
  { title: "Remix", icon: <SiRemix className={ICON} />, href: "https://hygo.ai/docs/guides/react/remix" },
  { title: "Sanity", icon: <SiSanity className={ICON} />, href: "https://hygo.ai/docs/guides/sanity" },
  { title: "Strapi", icon: <SiStrapi className={ICON} />, href: "https://hygo.ai/docs/guides/strapi" },
  { title: "Svelte", icon: <SiSvelte className={ICON} />, href: "https://hygo.ai/docs/guides/svelte/vite" },
  { title: "SvelteKit", icon: <SiSvelte className={ICON} />, href: "https://hygo.ai/docs/guides/svelte/sveltekit" },
  {
    title: "ThriveCart",
    icon: <img src="/platforms/thrivecart.svg" alt="" className={`${ICON} grayscale`} />,
    href: "https://hygo.ai/docs/guides/thrivecart",
  },
  { title: "VitePress", icon: <SiVitepress className={ICON} />, href: "https://hygo.ai/docs/guides/vitepress" },
  {
    title: "WooCommerce",
...
export function NoData() {
  ...
  const aiPrompt = `Install Hygo analytics on this website.\n\nAdd this script tag to the <head> of every page, using the root layout or base template if there is one:\n\n<script src="${scriptUrl}" defer></script>\n`;

  const rnInstallSnippet = "npm install @hygo/react-native @react-native-async-storage/async-storage";
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-wrap items-center gap-2 text-xs">
            {isMobileSite ? (
              <ExternalLink href="https://hygo.ai/docs/sdks/react-native">{t("React Native SDK docs")}</ExternalLink>
            ) : (
              <>
                <ExternalLink href="https://hygo.ai/docs/script">{t("Installation docs")}</ExternalLink>
